...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.workQueue': 'AI 작업 대기열',
  'workQueue.unavailable': '이 런타임에서는 AI 작업 대기열을 사용할 수 없습니다',
  'workQueue.window.description': 'AI 작업 대기열: AI가 생성한 분석으로 GitHub 및 Linear 이슈를 정리합니다',
  'workQueue.view.board': '보드',
  'workQueue.view.matrix': '매트릭스',
  'workQueue.view.list': '목록',
  'workQueue.view.calendar': '캘린더',
  'workQueue.view.comingSoon': '출시 예정',
  'workQueue.nav.queue': '대기열',
  'workQueue.nav.recommended': '추천',
  'workQueue.nav.critical': '긴급',
  'workQueue.nav.in_progress': '진행 중',
  'workQueue.nav.cloud_agents': '클라우드 에이전트',
  'workQueue.nav.done': '완료',
  'workQueue.nav.repositories': '저장소',
  'workQueue.toolbar.searchPlaceholder': '작업, 저장소, 작성자 검색...',

  'workQueue.toolbar.filters': '필터',
  'workQueue.toolbar.sync': '동기화',
  'workQueue.toolbar.filterAll': '전체',
  'workQueue.toolbar.filterRepo': '저장소',
  'workQueue.toolbar.filterAssignee': '담당자',
  'workQueue.toolbar.filterType': '유형',
  'workQueue.toolbar.filterPriority': '우선순위',
  'workQueue.toolbar.filterComplexity': '난이도',
  'workQueue.toolbar.resetFilters': '필터 초기화',
  'workQueue.type.issue': '이슈',
  'workQueue.type.pr': '풀 리퀘스트',
  'workQueue.issueType.bug': '버그',
  'workQueue.issueType.feature': '기능',
  'workQueue.issueType.enhancement': '개선',
  'workQueue.issueType.question': '질문',
  'workQueue.issueType.documentation': '문서',
  'workQueue.priority.critical': '긴급',
  'workQueue.priority.high': '높음',
  'workQueue.priority.medium': '보통',
  'workQueue.priority.low': '낮음',
  'workQueue.complexity.easy': '쉬움',
  'workQueue.complexity.medium': '보통',
  'workQueue.complexity.hard': '어려움',
  'workQueue.complexity.huge': '매우 어려움',
  'workQueue.env.headless': '헤드리스 환경 필요',
  'workQueue.env.browser': '브라우저 필요',
  'workQueue.env.docker': 'Docker 필요',
  'workQueue.status.todo': '할 일',
  'workQueue.status.in_progress': '진행 중',
  'workQueue.status.backlog': '백로그',
  'workQueue.status.done': '완료',
  'workQueue.board.toast.linearSyncFailed': '로컬에는 저장되었지만 Linear 동기화에 실패했습니다',
  'workQueue.board.toast.assigneeSyncFailed': '로컬에는 저장되었지만 담당자로 지정하지 못했습니다',
  'workQueue.board.emptyColumn': '여기에 작업을 놓으세요',
  'workQueue.list.empty': '현재 필터와 일치하는 작업이 없습니다',
  'workQueue.card.estimateMinutes': '{minutes}분',
  'workQueue.card.confidence': '신뢰도 {confidence}%',
  'workQueue.card.notAnalyzed': '아직 분석되지 않음',
  'workQueue.card.analysisError': '분석 실패',
  'workQueue.card.analyze': 'AI로 분석',
  'workQueue.card.reanalyze': '다시 분석',
  'workQueue.card.analyzing': '분석 중…',
  'workQueue.detail.close': '닫기',
  'workQueue.detail.tab.overview': '개요',
  'workQueue.detail.tab.analysis': 'AI 분석',
  'workQueue.detail.field.priority': '우선순위',
  'workQueue.detail.field.complexity': '복잡도',
  'workQueue.detail.field.confidence': 'AI 신뢰도',
  'workQueue.detail.field.estimate': '예상 소요 시간',
  'workQueue.detail.field.environment': '환경',
  'workQueue.detail.field.author': '작성자',
  'workQueue.detail.field.labels': '라벨',
  'workQueue.detail.field.generatedPrompt': '생성된 프롬프트',
  'workQueue.detail.cloudAgentStatus': '클라우드 에이전트: {status}',
  'workQueue.detail.actions.take': '작업 담당하기',
  'workQueue.detail.actions.openInOpenChamber': 'OpenChamber에서 열기',
  'workQueue.detail.actions.cloudAgent': '클라우드 에이전트로 전송',
  'workQueue.detail.actions.openCloudAgent': '에이전트 실행 보기',
  'workQueue.detail.actions.copyPrompt': '프롬프트 복사',
  'workQueue.detail.actions.openGitHub': 'GitHub에서 열기',
  'workQueue.detail.actions.openLinear': 'Linear에서 열기',
  'workQueue.detail.actions.finish': '완료',
  'workQueue.detail.actions.analyze': '분석',
  'workQueue.detail.actions.reanalyze': '다시 분석',
  'workQueue.detail.error.noActiveProject': '선택된 활성 프로젝트가 없습니다',
  'workQueue.detail.toast.analyzeFailed': '분석에 실패했습니다',
  'workQueue.detail.toast.promptCopied': '프롬프트가 클립보드에 복사되었습니다',
  'workQueue.detail.toast.copyFailed': '프롬프트 복사에 실패했습니다',
  'workQueue.detail.toast.cloudAgentFailed': '클라우드 에이전트를 실행하지 못했습니다',
  'workQueue.detail.toast.finished': '작업이 완료되어 보관되었습니다',
  'workQueue.detail.toast.finishIncomplete': '완료 처리가 끝나지 않았습니다 — GitHub/Linear 상태를 확인하세요',
  'workQueue.detail.tab.review': 'AI 리뷰',
  'workQueue.detail.field.description': '설명',

  'workQueue.detail.field.created': '생성일',
  'workQueue.detail.noDescription': '설명이 없습니다',
  'workQueue.detail.review.empty': '아직 자동 리뷰 댓글이 없습니다',
  'workQueue.detail.toast.cloudAgentLaunched': '클라우드 에이전트를 시작했습니다',
  'workQueue.toolbar.analyzeAll': '전체 분석',
  'workQueue.toolbar.analyzeAllWithCount': '전체 분석 ({count})',
  'workQueue.toolbar.sortLabel': '정렬',
  'workQueue.toolbar.sortDefault': '기본값',
  'workQueue.toolbar.sortNewest': '최신순',
  'workQueue.toolbar.sortOldest': '오래된순',
  'workQueue.toolbar.sortCriticality': '심각도순',
  'workQueue.toolbar.sortBugs': '버그 먼저',
  'workQueue.toolbar.sortFeatures': '기능 먼저',
  'workQueue.toolbar.toast.bulkAnalyzeDone': '{done}개 작업을 분석했습니다',
  'workQueue.toolbar.toast.bulkAnalyzePartial': '{done}개 분석, {failed}개 실패',
  'workQueue.toolbar.toast.bulkAnalyzeFailed': '일괄 분석에 실패했습니다',
  'workQueue.board.toast.linearCreateFailed': '로컬에 저장됨 — Linear 이슈를 생성하지 못했습니다',
  'workQueue.detail.analysis.alreadySolvedTitle': '이미 해결되었을 수 있음',
  'workQueue.detail.analysis.alreadySolvedEvidence': '커밋 {hash}에서 발견됨 — "{message}"',
  'workQueue.detail.analysis.duplicateTitle': '중복 가능성',
  'workQueue.detail.analysis.duplicateOf': '"{title}"와(과) 동일한 문제일 가능성이 있음',
  'workQueue.detail.actions.viewDuplicate': '원본 보기',
  'workQueue.detail.finishDialog.title': '작업 완료',
  'workQueue.detail.finishDialog.description': '이 작업을 어떻게 종료할지 선택하세요.',
  'workQueue.detail.finishDialog.reason.completed': '완료로 표시',
  'workQueue.detail.finishDialog.reason.duplicate': '중복으로 종료',
  'workQueue.detail.finishDialog.reason.notPlanned': '계획 없음으로 종료',
  'workQueue.detail.finishDialog.duplicateOfLabel': '중복 대상 (URL)',
  'workQueue.detail.finishDialog.duplicateOfPlaceholder': 'https://github.com/... 또는 Linear 이슈 URL',
  'workQueue.detail.finishDialog.cancel': '취소',
  'workQueue.detail.finishDialog.confirm': '작업 종료',
  'workQueue.detail.toast.closedDuplicate': '중복으로 종료됨',
  'workQueue.detail.toast.closedNotPlanned': '계획 없음으로 종료됨',
  'workQueue.detail.field.manualEvidence': '수동 증거',
  'workQueue.detail.actions.checkStaleness': '커밋 기록 확인',
  'workQueue.detail.staleness.match': '커밋 {hash}에서 발견됨 — "{message}"',
  'workQueue.detail.staleness.noMatches': '일치하는 커밋을 찾지 못했습니다',
  'workQueue.detail.field.attachedPr': '첨부된 PR',
  'workQueue.detail.toast.stalenessCheckFailed': '커밋 기록 확인에 실패했습니다',
  'workQueue.detail.toast.prAttached': 'PR이 첨부되었습니다',
  'workQueue.detail.toast.prAttachFailed': 'PR 첨부에 실패했습니다',
  'workQueue.detail.field.analysisModel': '분석 모델',
  'workQueue.detail.analysis.modelAuto': '자동 (연결된 모든 제공자)',
  'workQueue.detail.analysis.setDefaultModel': '기본 모델로 설정',
  'workQueue.detail.analysis.isDefaultModel': '분석용 기본 모델',
  'workQueue.detail.toast.defaultModelSet': '기본 분석 모델이 업데이트되었습니다',
  'workQueue.detail.toast.defaultModelSetFailed': '기본 분석 모델 업데이트에 실패했습니다',
  'workQueue.cloudAgent.dialog.title': '클라우드 에이전트로 보내기',
  'workQueue.cloudAgent.dialog.description': 'Cursor 백그라운드 에이전트를 시작하기 전에 프롬프트와 모델을 확인하세요.',
  'workQueue.cloudAgent.dialog.notConnected': 'Cursor가 연결되지 않았습니다 — 먼저 설정에서 API 키를 추가하세요.',
  'workQueue.cloudAgent.dialog.repository': '저장소',
  'workQueue.cloudAgent.dialog.model': '모델',
  'workQueue.cloudAgent.dialog.prompt': '프롬프트',
  'workQueue.cloudAgent.dialog.send': '보내기',

  'workQueue.cloudAgent.popup.title': '에이전트 시작됨',
  'workQueue.cloudAgent.popup.description': '에이전트가 백그라운드에서 이 작업을 진행 중입니다. 실행을 열어 진행 상황을 확인하세요.',
  'workQueue.cloudAgent.popup.openRun': '실행 열기',
  'workQueue.cloudAgent.popup.close': '나중에',
  'workQueue.cloudAgent.dialog.cancel': '취소',
};
