...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.cursorAria': 'Cursor 엔진',
  'sessions.sidebar.session.engine.cursorTooltip': 'Cursor에서 실행 중',
  ...
  'chat.engines.cursor.notReady': 'Cursor가 준비되지 않았습니다. 설정 → 엔진에서 로그인하거나 다시 감지하세요.',
  'chat.engines.cursor.shellUnsupported': 'Cursor에서는 셸 모드를 사용할 수 없습니다. OpenCode로 전환하거나 일반 메시지를 보내세요.',
  'chat.engines.cursor.slashUnsupported': 'Cursor에서는 슬래시 명령을 사용할 수 없습니다. OpenCode로 전환하거나 일반 메시지를 보내세요.',
  ...
  'chat.handoff.cursorBillingDialog.title': 'Cursor에서 계속할까요?',
  'chat.handoff.cursorBillingDialog.body': 'Cursor 구독을 사용해 새 세션을 시작합니다. OpenCode API 프로바이더는 그대로입니다. 대화 텍스트는 컨텍스트로 복사되며 원래 세션은 유지됩니다.',
