export const settingsDict = {
  ...
  'settings.page.aiWorkflow.title': 'Przepływ pracy AI',
...
'settings.harness.claudeCode.warnHandoff.info': 'Pokazuje okno dialogowe przed rozpoczęciem nowej sesji przy zmianie harnessu. Gdy wyłączone, zmiana stosowana jest po cichu przy następnej wiadomości.',
  ...
  'settings.linear.page.tooltip.connectWorkspace': 'Połącz obszar roboczy Linear, aby uruchamiać sesje ze zgłoszeń i raportować ich status.',
  'settings.linear.page.label.workspace': 'Obszar roboczy: {value}',
  'settings.linear.page.label.user': 'Użytkownik: {value}',
  'settings.linear.page.label.scopes': 'Zakresy: {value}',
  'settings.linear.page.status.connected': 'Połączono',
  'settings.linear.page.status.notConnected': 'Nie połączono',
  'settings.linear.page.status.notConfigured': 'Klient OAuth nie jest skonfigurowany na serwerze',
  'settings.linear.page.setupHint': 'Utwórz aplikację OAuth w Linear (Settings → API → OAuth applications) z URI przekierowania {redirectUri}, a następnie ustaw OPENCHAMBER_LINEAR_CLIENT_ID i OPENCHAMBER_LINEAR_CLIENT_SECRET (lub linearClientId/linearClientSecret w settings.json).',
  'settings.linear.page.actions.connect': 'Połącz Linear',
  'settings.linear.page.actions.disconnect': 'Rozłącz',
  'settings.linear.page.flow.waiting': 'Oczekiwanie na autoryzację w przeglądarce…',
  'settings.linear.page.flow.cancel': 'Anuluj',
  'settings.linear.page.toast.startConnectFailed': 'Nie udało się rozpocząć łączenia z Linear',
  'settings.linear.page.toast.connected': 'Połączono z Linear',
  'settings.linear.page.toast.disconnected': 'Rozłączono z Linear',
  'settings.linear.page.toast.disconnectFailed': 'Nie udało się rozłączyć Linear',
  'settings.linear.page.status.methodApiKey': 'Osobisty klucz API',
  'settings.linear.page.status.methodOauth': 'OAuth',
  'settings.linear.page.apiKey.label': 'Lub połącz się osobistym kluczem API',
  'settings.linear.page.apiKey.placeholder': 'lin_api_…',
  'settings.linear.page.apiKey.connect': 'Połącz klucz',
  'settings.linear.page.toast.apiKeyConnectFailed': 'Nie udało się połączyć za pomocą klucza API',
  'settings.linear.page.toast.automationUpdateFailed': 'Nie udało się zaktualizować automatyzacji Linear',
  'settings.linear.page.automation.moveToInProgress': 'Przenoś zgłoszenie do In Progress po rozpoczęciu sesji',
  'settings.linear.page.automation.moveToInProgress.info': 'Gdy sesja OpenChamber jest uruchamiana ze zgłoszenia w stanie Triage, Backlog lub Todo, zgłoszenie przechodzi do pierwszego rozpoczętego stanu zespołu.',
  'settings.linear.page.automation.moveToDone': 'Przenoś zgłoszenie do Done po zakończeniu sesji',
  'settings.linear.page.automation.moveToDone.info': 'Domyślnie wyłączone: sesja jest uznawana za zakończoną, gdy agent przechodzi w stan bezczynności, co zwykle dzieje się na długo przed faktycznym zakończeniem zgłoszenia.',
  'settings.cursor.page.title': 'Agenci w chmurze Cursor',
  'settings.cursor.page.tooltip.connectWorkspace': 'Połącz klucz API Cursor, aby uruchamiać agentów kodujących w tle z kolejki zadań AI.',
  'settings.cursor.page.status.connected': 'Połączono',
  'settings.cursor.page.status.notConnected': 'Nie połączono',
  'settings.cursor.page.status.configuredViaEnv': 'Skonfigurowano za pomocą zmiennej środowiskowej',
  'settings.cursor.page.apiKey.label': 'Klucz API Cursor',
  'settings.cursor.page.apiKey.placeholder': 'Wklej swój klucz API Cursor',
  'settings.cursor.page.actions.connect': 'Połącz',
  'settings.cursor.page.actions.disconnect': 'Rozłącz',
  'settings.cursor.page.toast.connected': 'Połączono z Cursor',
  'settings.cursor.page.toast.connectFailed': 'Nie udało się połączyć z Cursor',
  'settings.cursor.page.toast.disconnected': 'Rozłączono z Cursor',
  'settings.cursor.page.toast.disconnectFailed': 'Nie udało się rozłączyć z Cursor',
  'settings.cursor.page.repos.label': 'Śledzone repozytoria',
  'settings.cursor.page.repos.placeholder': 'właściciel/repozytorium',
  'settings.cursor.page.repos.add': 'Dodaj',
  'settings.cursor.page.repos.empty': 'Brak śledzonych repozytoriów',
  'settings.cursor.page.repos.remove': 'Usuń',
  'settings.cursor.page.toast.reposUpdateFailed': 'Nie udało się zaktualizować śledzonych repozytoriów',
  'settings.cursor.page.apiVersion.label': 'Wersja API',
  'settings.cursor.page.apiVersion.controlledByEnv': 'Kontrolowane przez OPENCHAMBER_CURSOR_API_VERSION',
  'settings.cursor.page.apiVersion.option.v0': 'v0 (starsza)',
  'settings.cursor.page.apiVersion.option.v1': 'v1 (oparta na run)',
  'settings.cursor.page.toast.apiVersionSaved': 'Zapisano wersję API',
  'settings.cursor.page.toast.apiVersionSaveFailed': 'Nie udało się zapisać wersji API',

  'settings.aiWorkflow.page.section.analysisModel': 'Domyślny model analizy',
  'settings.aiWorkflow.page.info.analysisModel': 'Model używany do analizy AI zgłoszeń i pull requestów w kolejce zadań. Pozostaw puste, aby automatycznie używać dowolnego dostawcy, do którego jesteś zalogowany.',
  'settings.aiWorkflow.page.field.analysisModel': 'Model',
  'settings.aiWorkflow.page.field.analysisModelAuto': 'Automatycznie (dowolny połączony dostawca)',
  'settings.aiWorkflow.page.section.analysisPrompt': 'Prompt analizy',
  'settings.aiWorkflow.page.info.analysisPrompt': 'Dodatkowe instrukcje dołączane do każdej analizy AI, oprócz wbudowanego promptu.',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': 'np. Zawsze oznaczaj jako wysoki priorytet wszystko związane z uwierzytelnianiem.',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': 'Prompt „już rozwiązane”',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': 'Dodatkowe instrukcje dotyczące tego, jak model ma oceniać, czy problem został już naprawiony przez istniejący commit.',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': 'np. Uznawaj commit za naprawę tylko wtedy, gdy bezpośrednio zmienia dotknięty plik.',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': 'Prompt agenta zdalnego',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': 'Tekst dołączany do promptu wysyłanego do zdalnego agenta kodującego (Cursor), oprócz wygenerowanego promptu analizy.',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': 'np. Stosuj się do konwencji projektu dotyczących komunikatów commitów i opisów PR.',
  'settings.aiWorkflow.page.toast.saveFailed': 'Nie udało się zapisać ustawień promptów Przepływu pracy AI',
};
