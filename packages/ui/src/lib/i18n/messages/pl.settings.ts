...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.engines.cursor.description': 'Agent Cursor z logowaniem OAuth subskrypcji.',
  'settings.engines.cursor.section.status': 'Status',
  'settings.engines.cursor.field.status': 'Status',
  'settings.engines.cursor.field.version': 'Wersja',
  'settings.engines.cursor.status.version': '{version}',
  'settings.engines.cursor.status.versionUnknown': 'Nieznana',
  'settings.engines.cursor.actions.login': 'Zaloguj się przez Cursor',
  'settings.engines.cursor.actions.loginAria': 'Rozpocznij logowanie Cursor',
  'settings.engines.cursor.actions.loginPending': 'Oczekiwanie na logowanie…',
  'settings.engines.cursor.actions.redetect': 'Wykryj ponownie',
  'settings.engines.cursor.actions.redetectAria': 'Ponownie wykryj status Cursor',
  'settings.engines.cursor.actions.openDocs': 'Otwórz dokumentację',
  'settings.engines.cursor.actions.openDocsAria': 'Otwórz dokumentację Cursor',
  'settings.engines.cursor.login.title': 'Zaloguj się do Cursor',
  'settings.engines.cursor.login.body': 'Otwórz logowanie Cursor w przeglądarce, a potem wróć tutaj. OpenChamber odpytuje, aż logowanie się zakończy.',
  'settings.engines.cursor.login.failed': 'Logowanie Cursor nie powiodło się. Spróbuj ponownie.',
  'settings.engines.cursor.login.timeout': 'Przekroczono limit czasu logowania Cursor. Spróbuj ponownie.',
  'settings.engines.cursor.section.capabilities': 'Możliwości',
  'settings.engines.cursor.capabilities.empty': 'Możliwości pojawią się po udanym wykryciu.',
  'settings.engines.cursor.capability.full': 'Pełne',
  'settings.engines.cursor.capability.partial': 'Częściowe',
  'settings.engines.cursor.capability.none': 'Niedostępne',
  'settings.engines.cursor.section.warnings': 'Ostrzeżenia',
  'settings.engines.cursor.warnHandoff.label': 'Ostrzegaj przy przełączaniu z OpenCode na Cursor',
  'settings.engines.cursor.warnHandoff.aria': 'Ostrzegaj przy przełączaniu z OpenCode na Cursor',
  'settings.engines.cursor.warnHandoff.info': 'Wyjaśnia, że nowa sesja korzysta z subskrypcji Cursor, a nie z rozliczeń API OpenCode.',
