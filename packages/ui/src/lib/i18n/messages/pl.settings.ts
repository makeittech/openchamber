...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.usage.overview.metric.vsPrevious': 'względem poprzedniego okresu',
  ...
  'settings.usage.overview.period.90d': '90 dni',
  'settings.usage.overview.period.custom': 'Niestandardowy',
  'settings.usage.overview.period.fromAria': 'Data rozpoczęcia okresu',
  'settings.usage.overview.period.toAria': 'Data zakończenia okresu',
  'settings.usage.overview.history.loading': 'Ładowanie historii użycia…',
  'settings.usage.overview.history.partial': 'Nie udało się załadować części historii sesji; dane mogą być niekompletne.',
  'settings.usage.overview.history.error': 'Nie udało się załadować historii użycia.',
  'settings.usage.overview.providers.other': 'Inne',
  'settings.usage.overview.providers.noUsage': 'Brak użycia w tym okresie',
