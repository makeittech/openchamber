...
export const dict = {
  ...
  'sessions.sidebar.session.engine.cursorAria': 'Cursor engine',
  'sessions.sidebar.session.engine.cursorTooltip': 'Running on Cursor',
  ...
  'chat.engines.cursor.notReady': 'Cursor is not ready. Open Settings → Engines to log in or re-detect.',
  'chat.engines.cursor.shellUnsupported': 'Shell mode is not available on Cursor. Switch to OpenCode or send a normal message.',
  'chat.engines.cursor.slashUnsupported': 'Slash commands are not available on Cursor. Switch to OpenCode or send a normal message.',
  ...
  'chat.handoff.cursorBillingDialog.title': 'Continue on Cursor?',
  'chat.handoff.cursorBillingDialog.body': 'This starts a new session on Cursor using your Cursor subscription. OpenCode API providers are unchanged. Conversation text is copied as context; the original session stays intact.',
