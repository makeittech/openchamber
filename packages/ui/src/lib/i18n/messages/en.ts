...
export const dict = {
  ...
  'sessions.sidebar.footer.actions.workQueue': 'AI Work Queue',
  'workQueue.unavailable': 'AI Work Queue is unavailable on this runtime',
  'workQueue.window.description': 'AI Work Queue: triage GitHub and Linear issues with AI-generated analysis',
  'workQueue.view.board': 'Board',
  'workQueue.view.matrix': 'Matrix',
  'workQueue.view.list': 'List',
  'workQueue.view.calendar': 'Calendar',
  'workQueue.view.comingSoon': 'Coming soon',
  'workQueue.nav.queue': 'Queue',
  'workQueue.nav.recommended': 'Recommended',
  'workQueue.nav.critical': 'Critical',
  'workQueue.nav.in_progress': 'In Progress',
  'workQueue.nav.cloud_agents': 'Cloud Agents',
  'workQueue.nav.done': 'Done',
  'workQueue.nav.repositories': 'Repositories',
  'workQueue.toolbar.searchPlaceholder': 'Search tasks, repos, authors...',

  'workQueue.toolbar.filters': 'Filters',
  'workQueue.toolbar.sync': 'Sync',
  'workQueue.toolbar.filterAll': 'All',
  'workQueue.toolbar.filterRepo': 'Repo',
  'workQueue.toolbar.filterAssignee': 'Assignee',
  'workQueue.toolbar.filterType': 'Type',
  'workQueue.toolbar.filterPriority': 'Priority',
  'workQueue.toolbar.filterComplexity': 'Difficulty',
  'workQueue.toolbar.resetFilters': 'Reset filters',
  'workQueue.type.issue': 'Issue',
  'workQueue.type.pr': 'Pull request',
  'workQueue.issueType.bug': 'Bug',
  'workQueue.issueType.feature': 'Feature',
  'workQueue.issueType.enhancement': 'Enhancement',
  'workQueue.issueType.question': 'Question',
  'workQueue.issueType.documentation': 'Documentation',
  'workQueue.priority.critical': 'Critical',
  'workQueue.priority.high': 'High',
  'workQueue.priority.medium': 'Medium',
  'workQueue.priority.low': 'Low',
  'workQueue.complexity.easy': 'Easy',
  'workQueue.complexity.medium': 'Medium',
  'workQueue.complexity.hard': 'Hard',
  'workQueue.complexity.huge': 'Huge',
  'workQueue.env.headless': 'Needs headless environment',
  'workQueue.env.browser': 'Needs a browser',
  'workQueue.env.docker': 'Needs Docker',
  'workQueue.status.todo': 'Todo',
  'workQueue.status.in_progress': 'In Progress',
  'workQueue.status.backlog': 'Backlog',
  'workQueue.status.done': 'Done',
  'workQueue.board.emptyColumn': 'Drop a task here',
  'workQueue.board.toast.linearSyncFailed': 'Saved locally — Linear sync failed',
  'workQueue.board.toast.assigneeSyncFailed': 'Saved locally — could not assign the issue to you',
  'workQueue.list.empty': 'No tasks match the current filters',
  'workQueue.card.estimateMinutes': '{minutes} min',
  'workQueue.card.confidence': '{confidence}% confidence',
  'workQueue.card.notAnalyzed': 'Not analyzed yet',
  'workQueue.card.analysisError': 'Analysis failed',
  'workQueue.card.analyze': 'Analyze with AI',
  'workQueue.card.reanalyze': 'Re-analyze',
  'workQueue.card.analyzing': 'Analyzing…',
  'workQueue.detail.close': 'Close',
  'workQueue.detail.tab.overview': 'Overview',
  'workQueue.detail.tab.analysis': 'AI Analysis',
  'workQueue.detail.field.priority': 'Priority',
  'workQueue.detail.field.complexity': 'Complexity',
  'workQueue.detail.field.confidence': 'AI confidence',
  'workQueue.detail.field.estimate': 'Time estimate',
  'workQueue.detail.field.environment': 'Environment',
  'workQueue.detail.field.author': 'Author',
  'workQueue.detail.field.labels': 'Labels',
  'workQueue.detail.field.generatedPrompt': 'Generated prompt',
  'workQueue.detail.cloudAgentStatus': 'Cloud agent: {status}',
  'workQueue.detail.actions.take': 'Take task',
  'workQueue.detail.actions.openInOpenChamber': 'Open in OpenChamber',
  'workQueue.detail.actions.cloudAgent': 'Send to cloud agent',
  'workQueue.detail.actions.openCloudAgent': 'View agent run',
  'workQueue.detail.actions.copyPrompt': 'Copy prompt',
  'workQueue.detail.actions.openGitHub': 'Open in GitHub',
  'workQueue.detail.actions.openLinear': 'Open in Linear',
  'workQueue.detail.actions.finish': 'Finish',
  'workQueue.detail.actions.analyze': 'Analyze',
  'workQueue.detail.actions.reanalyze': 'Re-analyze',
  'workQueue.detail.error.noActiveProject': 'No active project selected',
  'workQueue.detail.toast.analyzeFailed': 'Analysis failed',
  'workQueue.detail.toast.promptCopied': 'Prompt copied to clipboard',
  'workQueue.detail.toast.copyFailed': 'Failed to copy prompt',
  'workQueue.detail.toast.cloudAgentFailed': 'Failed to launch cloud agent',
  'workQueue.detail.toast.finished': 'Task finished and archived',
  'workQueue.detail.toast.finishIncomplete': 'Finish did not complete — check GitHub/Linear status',
  'workQueue.detail.tab.review': 'AI Review',
  'workQueue.detail.field.description': 'Description',

  'workQueue.detail.field.created': 'Created',
  'workQueue.detail.noDescription': 'No description provided',
  'workQueue.detail.review.empty': 'No automated review comments yet',
  'workQueue.detail.toast.cloudAgentLaunched': 'Cloud agent launched',
  'workQueue.toolbar.analyzeAll': 'Analyze all',
  'workQueue.toolbar.analyzeAllWithCount': 'Analyze all ({count})',
  'workQueue.toolbar.sortLabel': 'Sort',
  'workQueue.toolbar.sortDefault': 'Default',
  'workQueue.toolbar.sortNewest': 'Newest first',
  'workQueue.toolbar.sortOldest': 'Oldest first',
  'workQueue.toolbar.sortCriticality': 'By criticality',
  'workQueue.toolbar.sortBugs': 'Bugs first',
  'workQueue.toolbar.sortFeatures': 'Features first',
  'workQueue.toolbar.toast.bulkAnalyzeDone': 'Analyzed {done} tasks',
  'workQueue.toolbar.toast.bulkAnalyzePartial': 'Analyzed {done} tasks, {failed} failed',
  'workQueue.toolbar.toast.bulkAnalyzeFailed': 'Bulk analysis failed',
  'workQueue.board.toast.linearCreateFailed': 'Saved locally — could not create the Linear issue',
  'workQueue.detail.analysis.alreadySolvedTitle': 'Possibly already solved',
  'workQueue.detail.analysis.alreadySolvedEvidence': 'Found in commit {hash} — "{message}"',
  'workQueue.detail.analysis.duplicateTitle': 'Possible duplicate',
  'workQueue.detail.analysis.duplicateOf': 'Likely the same issue as "{title}"',
  'workQueue.detail.actions.viewDuplicate': 'View original',
  'workQueue.detail.finishDialog.title': 'Finish task',
  'workQueue.detail.finishDialog.description': 'Choose how this task is being closed.',
  'workQueue.detail.finishDialog.reason.completed': 'Mark completed',
  'workQueue.detail.finishDialog.reason.duplicate': 'Close as duplicate',
  'workQueue.detail.finishDialog.reason.notPlanned': 'Close as not planned',
  'workQueue.detail.finishDialog.duplicateOfLabel': 'Duplicate of (URL)',
  'workQueue.detail.finishDialog.duplicateOfPlaceholder': 'https://github.com/... or a Linear issue URL',
  'workQueue.detail.finishDialog.cancel': 'Cancel',
  'workQueue.detail.finishDialog.confirm': 'Close task',
  'workQueue.detail.toast.closedDuplicate': 'Closed as duplicate',
  'workQueue.detail.toast.closedNotPlanned': 'Closed as not planned',
  'workQueue.detail.field.manualEvidence': 'Manual evidence',
  'workQueue.detail.actions.checkStaleness': 'Check commit history',
  'workQueue.detail.staleness.match': 'Found in commit {hash} — "{message}"',
  'workQueue.detail.staleness.noMatches': 'No matching commits found',
  'workQueue.detail.field.attachedPr': 'Attached PR',
  'workQueue.detail.toast.stalenessCheckFailed': 'Commit history check failed',
  'workQueue.detail.toast.prAttached': 'PR attached',
  'workQueue.detail.toast.prAttachFailed': 'Failed to attach PR',
  'workQueue.detail.field.analysisModel': 'Analysis model',
  'workQueue.detail.analysis.modelAuto': 'Auto (any connected provider)',
  'workQueue.detail.analysis.setDefaultModel': 'Set as default model',
  'workQueue.detail.analysis.isDefaultModel': 'Default model for analysis',
  'workQueue.detail.toast.defaultModelSet': 'Default analysis model updated',
  'workQueue.detail.toast.defaultModelSetFailed': 'Failed to update default analysis model',
  'workQueue.cloudAgent.dialog.title': 'Send to cloud agent',
  'workQueue.cloudAgent.dialog.description': 'Review the prompt and model before dispatching a Cursor background agent.',
  'workQueue.cloudAgent.dialog.notConnected': 'Cursor is not connected — add an API key in Settings first.',
  ...
  'workQueue.cloudAgent.dialog.send': 'Send',

  'workQueue.cloudAgent.popup.title': 'Agent launched',
  'workQueue.cloudAgent.popup.description': 'The agent is now working on this task in the background. Open the run to follow its progress.',
  'workQueue.cloudAgent.popup.openRun': 'Open agent run',
  'workQueue.cloudAgent.popup.close': 'Not now',
  'workQueue.cloudAgent.dialog.cancel': 'Cancel',
} as const;
