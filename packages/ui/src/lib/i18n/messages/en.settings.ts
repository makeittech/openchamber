...
export const settingsDict = {
  ...
  'settings.page.aiWorkflow.title': 'AI Workflow',
...
'settings.harness.claudeCode.warnHandoff.info': 'Shows a dialog before starting a new session on harness switch. When off, the switch applies silently on your next message.',
  ...
  'settings.linear.page.tooltip.connectWorkspace': 'Connect a Linear workspace to start sessions from issues and report session status back.',
  'settings.linear.page.label.workspace': 'Workspace: {value}',
  'settings.linear.page.label.user': 'User: {value}',
  'settings.linear.page.label.scopes': 'Scopes: {value}',
  'settings.linear.page.status.connected': 'Connected',
  'settings.linear.page.status.notConnected': 'Not Connected',
  'settings.linear.page.status.notConfigured': 'OAuth client not configured on the server',
  'settings.linear.page.setupHint': 'Create an OAuth application in Linear (Settings → API → OAuth applications) with redirect URI {redirectUri}, then set OPENCHAMBER_LINEAR_CLIENT_ID and OPENCHAMBER_LINEAR_CLIENT_SECRET (or linearClientId/linearClientSecret in settings.json).',
  'settings.linear.page.actions.connect': 'Connect Linear',
  'settings.linear.page.actions.disconnect': 'Disconnect',
  'settings.linear.page.flow.waiting': 'Waiting for authorization in the browser…',
  'settings.linear.page.flow.cancel': 'Cancel',
  'settings.linear.page.toast.startConnectFailed': 'Failed to start Linear connect',
  'settings.linear.page.toast.connected': 'Linear connected',
  'settings.linear.page.toast.disconnected': 'Linear disconnected',
  'settings.linear.page.toast.disconnectFailed': 'Failed to disconnect Linear',
  'settings.linear.page.status.methodApiKey': 'Personal API key',
  'settings.linear.page.status.methodOauth': 'OAuth',
  'settings.linear.page.apiKey.label': 'Or connect with a personal API key',
  'settings.linear.page.apiKey.placeholder': 'lin_api_…',
  'settings.linear.page.apiKey.connect': 'Connect key',
  'settings.linear.page.toast.apiKeyConnectFailed': 'Failed to connect with the API key',
  'settings.linear.page.toast.automationUpdateFailed': 'Failed to update Linear automation',
  'settings.linear.page.automation.moveToInProgress': 'Move issue to In Progress when a session starts',
  'settings.linear.page.automation.moveToInProgress.info': 'When an OpenChamber session is started from an issue in Triage, Backlog, or Todo, the issue moves to the team’s first started state.',
  'settings.linear.page.automation.moveToDone': 'Move issue to Done when a session completes',
  'settings.linear.page.automation.moveToDone.info': 'Off by default: a session counts as completed whenever the agent goes idle, which usually happens long before the issue is actually done.',
  'settings.cursor.page.title': 'Cursor Cloud Agents',
  'settings.cursor.page.tooltip.connectWorkspace': 'Connect a Cursor API key to launch background coding agents from the AI Work Queue.',
  'settings.cursor.page.status.connected': 'Connected',
  'settings.cursor.page.status.notConnected': 'Not connected',
  'settings.cursor.page.status.configuredViaEnv': 'Configured via environment variable',
  'settings.cursor.page.apiKey.label': 'Cursor API key',
  'settings.cursor.page.apiKey.placeholder': 'Paste your Cursor API key',
  'settings.cursor.page.actions.connect': 'Connect',
  'settings.cursor.page.actions.disconnect': 'Disconnect',
  'settings.cursor.page.toast.connected': 'Cursor connected',
  'settings.cursor.page.toast.connectFailed': 'Failed to connect Cursor',
  'settings.cursor.page.toast.disconnected': 'Cursor disconnected',
  'settings.cursor.page.toast.disconnectFailed': 'Failed to disconnect Cursor',
  'settings.cursor.page.repos.label': 'Tracked repositories',
  'settings.cursor.page.repos.placeholder': 'owner/repo',
  'settings.cursor.page.repos.add': 'Add',
  'settings.cursor.page.repos.empty': 'No repositories tracked yet',
  'settings.cursor.page.repos.remove': 'Remove',
  'settings.cursor.page.toast.reposUpdateFailed': 'Failed to update tracked repositories',
  'settings.cursor.page.apiVersion.label': 'API version',
  'settings.cursor.page.apiVersion.controlledByEnv': 'Controlled by OPENCHAMBER_CURSOR_API_VERSION',
  'settings.cursor.page.apiVersion.option.v0': 'v0 (legacy)',
  'settings.cursor.page.apiVersion.option.v1': 'v1 (run-based)',
  'settings.cursor.page.toast.apiVersionSaved': 'API version saved',
  'settings.cursor.page.toast.apiVersionSaveFailed': 'Failed to save API version',

  'settings.aiWorkflow.page.section.analysisModel': 'Default analysis model',
  'settings.aiWorkflow.page.info.analysisModel': 'Model used for AI analysis of work queue issues and pull requests. Leave unset to automatically use any provider you\'re signed into.',
  'settings.aiWorkflow.page.field.analysisModel': 'Model',
  'settings.aiWorkflow.page.field.analysisModelAuto': 'Auto (any connected provider)',
  'settings.aiWorkflow.page.section.analysisPrompt': 'Analysis prompt',
  'settings.aiWorkflow.page.info.analysisPrompt': 'Extra instructions appended to every AI analysis pass, in addition to the built-in prompt.',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': 'e.g. Always flag anything touching authentication as high priority.',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': 'Already-solved prompt',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': 'Extra instructions for how the model should judge whether an issue is already fixed by an existing commit.',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': 'e.g. Only count a commit as a fix if it changes the affected file directly.',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': 'Remote agent prompt',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': 'Text appended to the prompt sent to a remote coding agent (Cursor), in addition to the generated analysis prompt.',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': 'e.g. Follow the project\'s commit message and PR description conventions.',
  'settings.aiWorkflow.page.toast.saveFailed': 'Failed to save AI Workflow prompt settings',
} as const;
