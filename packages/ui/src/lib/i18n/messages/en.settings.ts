export const settingsDict = {
  ...
  'settings.engines.cursor.description': 'Cursor agent with subscription OAuth login.',
  ...
  'settings.engines.cursor.status.versionUnknown': 'Unknown',
  'settings.engines.cursor.actions.login': 'Log in with Cursor',
  'settings.engines.cursor.actions.loginAria': 'Start Cursor login',
  'settings.engines.cursor.actions.loginPending': 'Waiting for login…',
  'settings.engines.cursor.actions.redetect': 'Re-detect',
  'settings.engines.cursor.actions.redetectAria': 'Re-detect Cursor status',
  'settings.engines.cursor.actions.openDocs': 'Open docs',
  'settings.engines.cursor.actions.openDocsAria': 'Open Cursor documentation',
  'settings.engines.cursor.login.title': 'Sign in with Cursor',
  'settings.engines.cursor.login.body': 'Open Cursor login in your browser, then return here. OpenChamber polls until login completes.',
  'settings.engines.cursor.login.failed': 'Cursor login failed. Try again.',
  'settings.engines.cursor.login.timeout': 'Cursor login timed out. Try again.',
  'settings.engines.cursor.section.capabilities': 'Capabilities',
  'settings.engines.cursor.capabilities.empty': 'Capabilities appear after a successful detect.',
  'settings.engines.cursor.capability.full': 'Full',
  'settings.engines.cursor.capability.partial': 'Partial',
  'settings.engines.cursor.capability.none': 'Not available',
  'settings.engines.cursor.section.warnings': 'Warnings',
  'settings.engines.cursor.warnHandoff.label': 'Warn when switching from OpenCode to Cursor',
  'settings.engines.cursor.warnHandoff.aria': 'Warn when switching from OpenCode to Cursor',
  'settings.engines.cursor.warnHandoff.info': 'Explains that the new session uses your Cursor subscription, not OpenCode API billing.',
