export const settingsDict = {
  ...
  'settings.usage.overview.period.90d': '90 days',
  'settings.usage.overview.period.custom': 'Custom',
  'settings.usage.overview.period.fromAria': 'Period start date',
  'settings.usage.overview.period.toAria': 'Period end date',
  'settings.usage.overview.history.loading': 'Loading usage history…',
  'settings.usage.overview.history.partial': 'Some session history could not be loaded; figures may be incomplete.',
  'settings.usage.overview.history.error': 'Usage history could not be loaded.',
  'settings.usage.overview.providers.other': 'Other',
  'settings.usage.overview.providers.noUsage': 'No usage in this period',
  ...
  'settings.usage.overview.metric.vsPrevious': 'vs previous period',
