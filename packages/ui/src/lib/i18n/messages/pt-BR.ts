...
export const dict: Record<I18nKey, string> = {
  ...
  "workQueue.unavailable": "A fila de trabalho de IA não está disponível neste ambiente",
  "workQueue.window.description": "Fila de trabalho de IA: triagem de issues do GitHub e Linear com análise gerada por IA",
  "workQueue.view.board": "Quadro",
  "workQueue.view.matrix": "Matriz",
  "workQueue.view.list": "Lista",
  "workQueue.view.calendar": "Calendário",
  "workQueue.view.comingSoon": "Em breve",
  "workQueue.nav.queue": "Fila",
  "workQueue.nav.recommended": "Recomendadas",
  "workQueue.nav.critical": "Críticas",
  "workQueue.nav.in_progress": "Em andamento",
  "workQueue.nav.cloud_agents": "Agentes na nuvem",
  "workQueue.nav.done": "Concluídas",
  "workQueue.nav.repositories": "Repositórios",
  "workQueue.toolbar.searchPlaceholder": "Buscar tarefas, repositórios, autores...",

  "workQueue.toolbar.filters": "Filtros",
  "workQueue.toolbar.sync": "Sincronizar",
  "workQueue.toolbar.filterAll": "Todas",
  "workQueue.toolbar.filterRepo": "Repositório",
  "workQueue.toolbar.filterAssignee": "Responsável",
  "workQueue.toolbar.filterType": "Tipo",
  "workQueue.toolbar.filterPriority": "Prioridade",
  "workQueue.toolbar.filterComplexity": "Dificuldade",
  "workQueue.toolbar.resetFilters": "Redefinir filtros",
  "workQueue.type.issue": "Issue",
  "workQueue.type.pr": "Pull request",
  "workQueue.issueType.bug": "Bug",
  "workQueue.issueType.feature": "Funcionalidade",
  "workQueue.issueType.enhancement": "Melhoria",
  "workQueue.issueType.question": "Pergunta",
  "workQueue.issueType.documentation": "Documentação",
  "workQueue.priority.critical": "Crítica",
  "workQueue.priority.high": "Alta",
  "workQueue.priority.medium": "Média",
  "workQueue.priority.low": "Baixa",
  "workQueue.complexity.easy": "Fácil",
  "workQueue.complexity.medium": "Média",
  "workQueue.complexity.hard": "Difícil",
  "workQueue.complexity.huge": "Enorme",
  "workQueue.env.headless": "Requer ambiente headless",
  "workQueue.env.browser": "Requer navegador",
  "workQueue.env.docker": "Requer Docker",
  "workQueue.status.todo": "A fazer",
  "workQueue.status.in_progress": "Em andamento",
  "workQueue.status.backlog": "Pendências",
  "workQueue.status.done": "Concluído",
  "workQueue.board.toast.linearSyncFailed": "Salvo localmente — falha na sincronização com o Linear",
  "workQueue.board.toast.assigneeSyncFailed": "Salvo localmente — não foi possível atribuir o item a você",
  "workQueue.board.emptyColumn": "Solte uma tarefa aqui",
  "workQueue.list.empty": "Nenhuma tarefa corresponde aos filtros atuais",
  "workQueue.card.estimateMinutes": "{minutes} min",
  "workQueue.card.confidence": "{confidence}% de confiança",
  "workQueue.card.notAnalyzed": "Ainda não analisada",
  "workQueue.card.analysisError": "Falha na análise",
  "workQueue.card.analyze": "Analisar com IA",
  "workQueue.card.reanalyze": "Reanalisar",
  "workQueue.card.analyzing": "Analisando…",
  "workQueue.detail.close": "Fechar",
  "workQueue.detail.tab.overview": "Visão geral",
  "workQueue.detail.tab.analysis": "Análise de IA",
  "workQueue.detail.field.priority": "Prioridade",
  "workQueue.detail.field.complexity": "Complexidade",
  "workQueue.detail.field.confidence": "Confiança da IA",
  "workQueue.detail.field.estimate": "Estimativa de tempo",
  "workQueue.detail.field.environment": "Ambiente",
  "workQueue.detail.field.author": "Autor",
  "workQueue.detail.field.labels": "Etiquetas",
  "workQueue.detail.field.generatedPrompt": "Prompt gerado",
  "workQueue.detail.cloudAgentStatus": "Agente na nuvem: {status}",
  "workQueue.detail.actions.take": "Assumir tarefa",
  "workQueue.detail.actions.openInOpenChamber": "Abrir no OpenChamber",
  "workQueue.detail.actions.cloudAgent": "Enviar para agente na nuvem",
  "workQueue.detail.actions.openCloudAgent": "Ver execução do agente",
  "workQueue.detail.actions.copyPrompt": "Copiar prompt",
  "workQueue.detail.actions.openGitHub": "Abrir no GitHub",
  "workQueue.detail.actions.openLinear": "Abrir no Linear",
  "workQueue.detail.actions.finish": "Concluir",
  "workQueue.detail.actions.analyze": "Analisar",
  "workQueue.detail.actions.reanalyze": "Analisar novamente",
  "workQueue.detail.error.noActiveProject": "Nenhum projeto ativo selecionado",
  "workQueue.detail.toast.analyzeFailed": "Falha na análise",
  "workQueue.detail.toast.promptCopied": "Prompt copiado para a área de transferência",
  "workQueue.detail.toast.copyFailed": "Falha ao copiar o prompt",
  "workQueue.detail.toast.cloudAgentFailed": "Falha ao iniciar o agente na nuvem",
  "workQueue.detail.toast.finished": "Tarefa concluída e arquivada",
  "workQueue.detail.toast.finishIncomplete": "A conclusão não foi concluída — verifique o status do GitHub/Linear",
  "sessions.sidebar.footer.actions.workQueue": "Fila de trabalho de IA",
  "workQueue.detail.tab.review": "Revisão de IA",
  "workQueue.detail.field.description": "Descrição",

  "workQueue.detail.field.created": "Criado em",
  "workQueue.detail.noDescription": "Nenhuma descrição fornecida",
  "workQueue.detail.review.empty": "Ainda não há comentários de revisão automatizada",
  "workQueue.detail.toast.cloudAgentLaunched": "Agente na nuvem iniciado",
  "workQueue.toolbar.analyzeAll": "Analisar tudo",
  "workQueue.toolbar.analyzeAllWithCount": "Analisar tudo ({count})",
  "workQueue.toolbar.sortLabel": "Ordenação",
  "workQueue.toolbar.sortDefault": "Padrão",
  "workQueue.toolbar.sortNewest": "Mais recentes primeiro",
  "workQueue.toolbar.sortOldest": "Mais antigos primeiro",
  "workQueue.toolbar.sortCriticality": "Por criticidade",
  "workQueue.toolbar.sortBugs": "Bugs primeiro",
  "workQueue.toolbar.sortFeatures": "Funcionalidades primeiro",
  "workQueue.toolbar.toast.bulkAnalyzeDone": "{done} tarefas analisadas",
  "workQueue.toolbar.toast.bulkAnalyzePartial": "{done} tarefas analisadas, {failed} com falha",
  "workQueue.toolbar.toast.bulkAnalyzeFailed": "Falha na análise em massa",
  "workQueue.board.toast.linearCreateFailed": "Salvo localmente — não foi possível criar o item no Linear",
  "workQueue.detail.analysis.alreadySolvedTitle": "Possivelmente já resolvido",
  "workQueue.detail.analysis.alreadySolvedEvidence": "Encontrado no commit {hash} — \"{message}\"",
  "workQueue.detail.analysis.duplicateTitle": "Possível duplicata",
  "workQueue.detail.analysis.duplicateOf": "Provavelmente o mesmo problema que \"{title}\"",
  "workQueue.detail.actions.viewDuplicate": "Ver original",
  "workQueue.detail.finishDialog.title": "Concluir tarefa",
  "workQueue.detail.finishDialog.description": "Escolha como esta tarefa será encerrada.",
  "workQueue.detail.finishDialog.reason.completed": "Marcar como concluída",
  "workQueue.detail.finishDialog.reason.duplicate": "Encerrar como duplicata",
  "workQueue.detail.finishDialog.reason.notPlanned": "Encerrar como não planejada",
  "workQueue.detail.finishDialog.duplicateOfLabel": "Duplicata de (URL)",
  "workQueue.detail.finishDialog.duplicateOfPlaceholder": "https://github.com/... ou uma URL de item do Linear",
  "workQueue.detail.finishDialog.cancel": "Cancelar",
  "workQueue.detail.finishDialog.confirm": "Encerrar tarefa",
  "workQueue.detail.toast.closedDuplicate": "Encerrada como duplicata",
  "workQueue.detail.toast.closedNotPlanned": "Encerrada como não planejada",
  "workQueue.detail.field.manualEvidence": "Evidência manual",
  "workQueue.detail.actions.checkStaleness": "Verificar histórico de commits",
  "workQueue.detail.staleness.match": "Encontrado no commit {hash} — \"{message}\"",
  "workQueue.detail.staleness.noMatches": "Nenhum commit correspondente encontrado",
  "workQueue.detail.field.attachedPr": "PR anexado",
  "workQueue.detail.toast.stalenessCheckFailed": "Falha ao verificar o histórico de commits",
  "workQueue.detail.toast.prAttached": "PR anexado",
  "workQueue.detail.toast.prAttachFailed": "Falha ao anexar o PR",
  "workQueue.detail.field.analysisModel": "Modelo de análise",
  "workQueue.detail.analysis.modelAuto": "Automático (qualquer provedor conectado)",
  "workQueue.detail.analysis.setDefaultModel": "Definir como modelo padrão",
  "workQueue.detail.analysis.isDefaultModel": "Modelo padrão para análise",
  "workQueue.detail.toast.defaultModelSet": "Modelo de análise padrão atualizado",
  "workQueue.detail.toast.defaultModelSetFailed": "Falha ao atualizar o modelo de análise padrão",
  "workQueue.cloudAgent.dialog.title": "Enviar para agente na nuvem",
  "workQueue.cloudAgent.dialog.description": "Revise o prompt e o modelo antes de iniciar um agente do Cursor em segundo plano.",
  "workQueue.cloudAgent.dialog.notConnected": "O Cursor não está conectado — adicione primeiro uma chave de API nas Configurações.",
  "workQueue.cloudAgent.dialog.repository": "Repositório",
  ...
  "workQueue.cloudAgent.popup.description": "O agente já está trabalhando nesta tarefa em segundo plano. Abra a execução para acompanhar o progresso.",
  "workQueue.cloudAgent.popup.openRun": "Abrir execução",
  "workQueue.cloudAgent.popup.close": "Agora não",
