...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.harness.slashUnsupported": "Este comando slash do OpenCode não está disponível no Claude Code. Use um /comando nativo do Claude ou envie uma mensagem normal.",
