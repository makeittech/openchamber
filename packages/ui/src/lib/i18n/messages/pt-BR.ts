...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.cursorAria": "Mecanismo Cursor",
  "sessions.sidebar.session.engine.cursorTooltip": "Em execução no Cursor",
  ...
  "chat.engines.cursor.notReady": "O Cursor não está pronto. Abra Configurações → Mecanismos para entrar ou detectar novamente.",
  "chat.engines.cursor.shellUnsupported": "O modo shell não está disponível no Cursor. Mude para o OpenCode ou envie uma mensagem normal.",
  "chat.engines.cursor.slashUnsupported": "Comandos com barra não estão disponíveis no Cursor. Mude para o OpenCode ou envie uma mensagem normal.",
  ...
  "chat.handoff.cursorBillingDialog.title": "Continuar no Cursor?",
  "chat.handoff.cursorBillingDialog.body": "Isso inicia uma nova sessão no Cursor usando sua assinatura Cursor. Os provedores de API do OpenCode permanecem iguais. O texto da conversa é copiado como contexto; a sessão original permanece intacta.",
