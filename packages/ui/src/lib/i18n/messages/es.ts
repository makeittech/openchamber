...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.harness.slashUnsupported": "Este comando slash de OpenCode no está disponible en Claude Code. Usa un /comando nativo de Claude o envía un mensaje normal.",
