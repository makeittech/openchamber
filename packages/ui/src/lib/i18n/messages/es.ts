...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.cursorAria": "Motor Cursor",
  "sessions.sidebar.session.engine.cursorTooltip": "Ejecutándose en Cursor",
  ...
  "chat.engines.cursor.notReady": "Cursor no está listo. Abre Ajustes → Motores para iniciar sesión o volver a detectar.",
  "chat.engines.cursor.shellUnsupported": "El modo shell no está disponible en Cursor. Cambia a OpenCode o envía un mensaje normal.",
  "chat.engines.cursor.slashUnsupported": "Los comandos con barra no están disponibles en Cursor. Cambia a OpenCode o envía un mensaje normal.",
  ...
  "chat.handoff.cursorBillingDialog.title": "¿Continuar en Cursor?",
  "chat.handoff.cursorBillingDialog.body": "Esto inicia una nueva sesión en Cursor usando tu suscripción de Cursor. Los proveedores de API de OpenCode no cambian. El texto de la conversación se copia como contexto; la sesión original se mantiene.",
