...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.revert.toast.unsupportedHarness": "La reversión no está disponible en sesiones de Claude Code",
  ...
  "workQueue.unavailable": "La cola de trabajo de IA no está disponible en este entorno",
  "workQueue.window.description": "Cola de trabajo de IA: clasifica issues de GitHub y Linear con análisis generado por IA",
  "workQueue.view.board": "Tablero",
  "workQueue.view.matrix": "Matriz",
  "workQueue.view.list": "Lista",
  "workQueue.view.calendar": "Calendario",
  "workQueue.view.comingSoon": "Próximamente",
  "workQueue.nav.queue": "Cola",
  "workQueue.nav.recommended": "Recomendadas",
  "workQueue.nav.critical": "Críticas",
  "workQueue.nav.in_progress": "En curso",
  "workQueue.nav.cloud_agents": "Agentes en la nube",
  "workQueue.nav.done": "Hechas",
  "workQueue.nav.repositories": "Repositorios",
  "workQueue.toolbar.searchPlaceholder": "Buscar tareas, repos, autores...",

  "workQueue.toolbar.filters": "Filtros",
  "workQueue.toolbar.sync": "Sincronizar",
  "workQueue.toolbar.filterAll": "Todas",
  "workQueue.toolbar.filterRepo": "Repositorio",
  "workQueue.toolbar.filterAssignee": "Asignado",
  "workQueue.toolbar.filterType": "Tipo",
  "workQueue.toolbar.filterPriority": "Prioridad",
  "workQueue.toolbar.filterComplexity": "Dificultad",
  "workQueue.toolbar.resetFilters": "Restablecer filtros",
  "workQueue.type.issue": "Issue",
  "workQueue.type.pr": "Pull request",
  "workQueue.issueType.bug": "Error",
  "workQueue.issueType.feature": "Función",
  "workQueue.issueType.enhancement": "Mejora",
  "workQueue.issueType.question": "Pregunta",
  "workQueue.issueType.documentation": "Documentación",
  "workQueue.priority.critical": "Crítica",
  "workQueue.priority.high": "Alta",
  "workQueue.priority.medium": "Media",
  "workQueue.priority.low": "Baja",
  "workQueue.complexity.easy": "Fácil",
  "workQueue.complexity.medium": "Media",
  "workQueue.complexity.hard": "Difícil",
  "workQueue.complexity.huge": "Enorme",
  "workQueue.env.headless": "Requiere entorno headless",
  "workQueue.env.browser": "Requiere navegador",
  "workQueue.env.docker": "Requiere Docker",
  "workQueue.status.todo": "Por hacer",
  "workQueue.status.in_progress": "En curso",
  "workQueue.status.backlog": "Pendientes",
  "workQueue.status.done": "Hecho",
  "workQueue.board.toast.linearSyncFailed": "Guardado localmente: falló la sincronización con Linear",
  "workQueue.board.toast.assigneeSyncFailed": "Guardado localmente: no se pudo asignarte la incidencia",
  "workQueue.board.emptyColumn": "Suelta una tarea aquí",
  "workQueue.list.empty": "Ninguna tarea coincide con los filtros actuales",
  "workQueue.card.estimateMinutes": "{minutes} min",
  "workQueue.card.confidence": "{confidence}% de confianza",
  "workQueue.card.notAnalyzed": "Aún no analizada",
  "workQueue.card.analysisError": "Error en el análisis",
  "workQueue.card.analyze": "Analizar con IA",
  "workQueue.card.reanalyze": "Reanalizar",
  "workQueue.card.analyzing": "Analizando…",
  "workQueue.detail.close": "Cerrar",
  "workQueue.detail.tab.overview": "Resumen",
  "workQueue.detail.tab.analysis": "Análisis de IA",
  "workQueue.detail.field.priority": "Prioridad",
  "workQueue.detail.field.complexity": "Complejidad",
  "workQueue.detail.field.confidence": "Confianza de la IA",
  "workQueue.detail.field.estimate": "Estimación de tiempo",
  "workQueue.detail.field.environment": "Entorno",
  "workQueue.detail.field.author": "Autor",
  "workQueue.detail.field.labels": "Etiquetas",
  "workQueue.detail.field.generatedPrompt": "Prompt generado",
  "workQueue.detail.cloudAgentStatus": "Agente en la nube: {status}",
  "workQueue.detail.actions.take": "Tomar tarea",
  "workQueue.detail.actions.openInOpenChamber": "Abrir en OpenChamber",
  "workQueue.detail.actions.cloudAgent": "Enviar a agente en la nube",
  "workQueue.detail.actions.openCloudAgent": "Ver ejecución del agente",
  "workQueue.detail.actions.copyPrompt": "Copiar prompt",
  "workQueue.detail.actions.openGitHub": "Abrir en GitHub",
  "workQueue.detail.actions.openLinear": "Abrir en Linear",
  "workQueue.detail.actions.finish": "Finalizar",
  "workQueue.detail.actions.analyze": "Analizar",
  "workQueue.detail.actions.reanalyze": "Volver a analizar",
  "workQueue.detail.error.noActiveProject": "No hay ningún proyecto activo seleccionado",
  "workQueue.detail.toast.analyzeFailed": "Error en el análisis",
  "workQueue.detail.toast.promptCopied": "Prompt copiado al portapapeles",
  "workQueue.detail.toast.copyFailed": "No se pudo copiar el prompt",
  "workQueue.detail.toast.cloudAgentFailed": "No se pudo lanzar el agente en la nube",
  "workQueue.detail.toast.finished": "Tarea finalizada y archivada",
  "workQueue.detail.toast.finishIncomplete": "La finalización no se completó — revisa el estado de GitHub/Linear",
  "sessions.sidebar.footer.actions.workQueue": "Cola de trabajo de IA",
  "workQueue.detail.tab.review": "Revisión de IA",
  "workQueue.detail.field.description": "Descripción",

  "workQueue.detail.field.created": "Creado",
  "workQueue.detail.noDescription": "No se proporcionó descripción",
  "workQueue.detail.review.empty": "Aún no hay comentarios de revisión automatizada",
  "workQueue.detail.toast.cloudAgentLaunched": "Agente en la nube lanzado",
  "workQueue.toolbar.analyzeAll": "Analizar todo",
  "workQueue.toolbar.analyzeAllWithCount": "Analizar todo ({count})",
  "workQueue.toolbar.sortLabel": "Orden",
  "workQueue.toolbar.sortDefault": "Predeterminado",
  "workQueue.toolbar.sortNewest": "Más recientes primero",
  "workQueue.toolbar.sortOldest": "Más antiguos primero",
  "workQueue.toolbar.sortCriticality": "Por criticidad",
  "workQueue.toolbar.sortBugs": "Errores primero",
  "workQueue.toolbar.sortFeatures": "Funciones primero",
  "workQueue.toolbar.toast.bulkAnalyzeDone": "{done} tareas analizadas",
  "workQueue.toolbar.toast.bulkAnalyzePartial": "{done} tareas analizadas, {failed} fallidas",
  "workQueue.toolbar.toast.bulkAnalyzeFailed": "Error en el análisis masivo",
  "workQueue.board.toast.linearCreateFailed": "Guardado localmente — no se pudo crear el issue de Linear",
  "workQueue.detail.analysis.alreadySolvedTitle": "Posiblemente ya resuelto",
  "workQueue.detail.analysis.alreadySolvedEvidence": "Encontrado en el commit {hash} — «{message}»",
  "workQueue.detail.analysis.duplicateTitle": "Posible duplicado",
  "workQueue.detail.analysis.duplicateOf": "Probablemente el mismo problema que «{title}»",
  "workQueue.detail.actions.viewDuplicate": "Ver el original",
  "workQueue.detail.finishDialog.title": "Finalizar tarea",
  "workQueue.detail.finishDialog.description": "Elige cómo se cierra esta tarea.",
  "workQueue.detail.finishDialog.reason.completed": "Marcar como completada",
  "workQueue.detail.finishDialog.reason.duplicate": "Cerrar como duplicado",
  "workQueue.detail.finishDialog.reason.notPlanned": "Cerrar como no planificado",
  "workQueue.detail.finishDialog.duplicateOfLabel": "Duplicado de (URL)",
  "workQueue.detail.finishDialog.duplicateOfPlaceholder": "https://github.com/... o una URL de issue de Linear",
  "workQueue.detail.finishDialog.cancel": "Cancelar",
  "workQueue.detail.finishDialog.confirm": "Cerrar tarea",
  "workQueue.detail.toast.closedDuplicate": "Cerrada como duplicado",
  "workQueue.detail.toast.closedNotPlanned": "Cerrada como no planificada",
  "workQueue.detail.field.manualEvidence": "Evidencia manual",
  "workQueue.detail.actions.checkStaleness": "Comprobar historial de commits",
  "workQueue.detail.staleness.match": "Encontrado en el commit {hash} — «{message}»",
  "workQueue.detail.staleness.noMatches": "No se encontraron commits coincidentes",
  "workQueue.detail.field.attachedPr": "PR adjunto",
  "workQueue.detail.toast.stalenessCheckFailed": "Error al comprobar el historial de commits",
  "workQueue.detail.toast.prAttached": "PR adjuntado",
  "workQueue.detail.toast.prAttachFailed": "No se pudo adjuntar el PR",
  "workQueue.detail.field.analysisModel": "Modelo de análisis",
  "workQueue.detail.analysis.modelAuto": "Automático (cualquier proveedor conectado)",
  "workQueue.detail.analysis.setDefaultModel": "Establecer como modelo predeterminado",
  "workQueue.detail.analysis.isDefaultModel": "Modelo predeterminado para el análisis",
  "workQueue.detail.toast.defaultModelSet": "Modelo de análisis predeterminado actualizado",
  "workQueue.detail.toast.defaultModelSetFailed": "No se pudo actualizar el modelo de análisis predeterminado",
  "workQueue.cloudAgent.dialog.title": "Enviar al agente en la nube",
  "workQueue.cloudAgent.dialog.description": "Revisa el prompt y el modelo antes de lanzar un agente de Cursor en segundo plano.",
  "workQueue.cloudAgent.dialog.notConnected": "Cursor no está conectado — añade primero una clave de API en Ajustes.",
  "workQueue.cloudAgent.dialog.repository": "Repositorio",
  "workQueue.cloudAgent.dialog.model": "Modelo",
  "workQueue.cloudAgent.dialog.prompt": "Prompt",
  "workQueue.cloudAgent.dialog.send": "Enviar",

  "workQueue.cloudAgent.popup.title": "Agente iniciado",
  "workQueue.cloudAgent.popup.description": "El agente ya está trabajando en esta tarea en segundo plano. Abre la ejecución para seguir su progreso.",
  "workQueue.cloudAgent.popup.openRun": "Abrir ejecución",
  "workQueue.cloudAgent.popup.close": "Ahora no",
  "workQueue.cloudAgent.dialog.cancel": "Cancelar",
};
