...
export const settingsDict = {
  ...
  'settings.page.aiWorkflow.title': 'AI 워크플로',
...
'settings.harness.claudeCode.warnHandoff.info': '하네스 전환 시 새 세션을 시작하기 전에 대화 상자를 표시합니다. 끄면 다음 메시지에서 자동으로 전환됩니다.',
  ...
  'settings.linear.page.tooltip.connectWorkspace': 'Linear 워크스페이스를 연결하여 이슈에서 세션을 시작하고 세션 상태를 다시 보고합니다.',
  'settings.linear.page.label.workspace': '워크스페이스: {value}',
  'settings.linear.page.label.user': '사용자: {value}',
  'settings.linear.page.label.scopes': '범위: {value}',
  'settings.linear.page.status.connected': '연결됨',
  'settings.linear.page.status.notConnected': '연결되지 않음',
  'settings.linear.page.status.notConfigured': '서버에 OAuth 클라이언트가 구성되어 있지 않습니다',
  'settings.linear.page.setupHint': 'Linear에서 OAuth 애플리케이션을 만들고(Settings → API → OAuth applications) 리디렉션 URI를 {redirectUri}로 설정한 다음 OPENCHAMBER_LINEAR_CLIENT_ID와 OPENCHAMBER_LINEAR_CLIENT_SECRET(또는 settings.json의 linearClientId/linearClientSecret)을 설정하세요.',
  'settings.linear.page.actions.connect': 'Linear 연결',
  'settings.linear.page.actions.disconnect': '연결 해제',
  'settings.linear.page.flow.waiting': '브라우저에서 인증을 기다리는 중…',
  'settings.linear.page.flow.cancel': '취소',
  'settings.linear.page.toast.startConnectFailed': 'Linear 연결을 시작하지 못했습니다',
  'settings.linear.page.toast.connected': 'Linear가 연결되었습니다',
  'settings.linear.page.toast.disconnected': 'Linear 연결이 해제되었습니다',
  'settings.linear.page.toast.disconnectFailed': 'Linear 연결을 해제하지 못했습니다',
  'settings.linear.page.status.methodApiKey': '개인 API 키',
  'settings.linear.page.status.methodOauth': 'OAuth',
  'settings.linear.page.apiKey.label': '또는 개인 API 키로 연결',
  'settings.linear.page.apiKey.placeholder': 'lin_api_…',
  'settings.linear.page.apiKey.connect': '키 연결',
  'settings.linear.page.toast.apiKeyConnectFailed': 'API 키로 연결하지 못했습니다',
  'settings.linear.page.toast.automationUpdateFailed': 'Linear 자동화를 업데이트하지 못했습니다',
  'settings.linear.page.automation.moveToInProgress': '세션 시작 시 이슈를 In Progress로 이동',
  'settings.linear.page.automation.moveToInProgress.info': 'Triage, Backlog 또는 Todo 상태의 이슈에서 OpenChamber 세션을 시작하면 해당 이슈가 팀의 첫 번째 시작 상태로 이동합니다.',
  'settings.linear.page.automation.moveToDone': '세션 완료 시 이슈를 Done으로 이동',
  'settings.linear.page.automation.moveToDone.info': '기본적으로 꺼져 있습니다: 세션은 에이전트가 유휴 상태가 되면 완료된 것으로 간주되며, 이는 일반적으로 이슈가 실제로 완료되기 훨씬 전입니다.',
  'settings.cursor.page.title': 'Cursor 클라우드 에이전트',
  'settings.cursor.page.tooltip.connectWorkspace': 'Cursor API 키를 연결하면 AI 작업 대기열에서 백그라운드 코딩 에이전트를 실행할 수 있습니다.',
  'settings.cursor.page.status.connected': '연결됨',
  'settings.cursor.page.status.notConnected': '연결되지 않음',
  'settings.cursor.page.status.configuredViaEnv': '환경 변수로 설정됨',
  'settings.cursor.page.apiKey.label': 'Cursor API 키',
  'settings.cursor.page.apiKey.placeholder': 'Cursor API 키를 붙여넣으세요',
  'settings.cursor.page.actions.connect': '연결',
  'settings.cursor.page.actions.disconnect': '연결 해제',
  'settings.cursor.page.toast.connected': 'Cursor에 연결되었습니다',
  'settings.cursor.page.toast.connectFailed': 'Cursor 연결에 실패했습니다',
  'settings.cursor.page.toast.disconnected': 'Cursor 연결이 해제되었습니다',
  'settings.cursor.page.toast.disconnectFailed': 'Cursor 연결 해제에 실패했습니다',
  'settings.cursor.page.repos.label': '추적 중인 저장소',
  'settings.cursor.page.repos.placeholder': 'owner/repo',
  'settings.cursor.page.repos.add': '추가',
  'settings.cursor.page.repos.empty': '아직 추적 중인 저장소가 없습니다',
  'settings.cursor.page.repos.remove': '제거',
  'settings.cursor.page.toast.reposUpdateFailed': '추적 저장소 업데이트에 실패했습니다',
  'settings.cursor.page.apiVersion.label': 'API 버전',
  'settings.cursor.page.apiVersion.controlledByEnv': 'OPENCHAMBER_CURSOR_API_VERSION으로 제어됨',
  'settings.cursor.page.apiVersion.option.v0': 'v0 (레거시)',
  'settings.cursor.page.apiVersion.option.v1': 'v1 (실행 기반)',
  'settings.cursor.page.toast.apiVersionSaved': 'API 버전이 저장되었습니다',
  'settings.cursor.page.toast.apiVersionSaveFailed': 'API 버전을 저장하지 못했습니다',

  'settings.aiWorkflow.page.section.analysisModel': '기본 분석 모델',
  'settings.aiWorkflow.page.info.analysisModel': '작업 대기열의 이슈 및 풀 리퀘스트에 대한 AI 분석에 사용되는 모델입니다. 설정하지 않으면 로그인된 모든 제공자를 자동으로 사용합니다.',
  'settings.aiWorkflow.page.field.analysisModel': '모델',
  'settings.aiWorkflow.page.field.analysisModelAuto': '자동 (연결된 모든 제공자)',
  'settings.aiWorkflow.page.section.analysisPrompt': '분석 프롬프트',
  'settings.aiWorkflow.page.info.analysisPrompt': '기본 제공 프롬프트에 추가로 모든 AI 분석 실행마다 덧붙는 추가 지침입니다.',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': '예: 인증과 관련된 항목은 항상 우선순위 높음으로 표시합니다.',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': '이미 해결됨 프롬프트',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': '기존 커밋으로 이슈가 이미 해결되었는지 모델이 판단하는 방식에 대한 추가 지침입니다.',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': '예: 영향을 받은 파일을 직접 변경하는 커밋만 수정으로 간주합니다.',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': '원격 에이전트 프롬프트',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': '생성된 분석 프롬프트에 추가로 원격 코딩 에이전트(Cursor)에 전송되는 프롬프트에 덧붙는 텍스트입니다.',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': '예: 프로젝트의 커밋 메시지 및 PR 설명 규칙을 따릅니다.',
  'settings.aiWorkflow.page.toast.saveFailed': 'AI 워크플로 프롬프트 설정을 저장하지 못했습니다',
} as const;
