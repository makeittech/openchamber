...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.engines.cursor.description': '구독 OAuth 로그인을 사용하는 Cursor 에이전트입니다.',
  'settings.engines.cursor.section.status': '상태',
  'settings.engines.cursor.field.status': '상태',
  'settings.engines.cursor.field.version': '버전',
  'settings.engines.cursor.status.version': '{version}',
  'settings.engines.cursor.status.versionUnknown': '알 수 없음',
  'settings.engines.cursor.actions.login': 'Cursor로 로그인',
  'settings.engines.cursor.actions.loginAria': 'Cursor 로그인 시작',
  'settings.engines.cursor.actions.loginPending': '로그인 대기 중…',
  'settings.engines.cursor.actions.redetect': '다시 감지',
  'settings.engines.cursor.actions.redetectAria': 'Cursor 상태 다시 감지',
  'settings.engines.cursor.actions.openDocs': '문서 열기',
  'settings.engines.cursor.actions.openDocsAria': 'Cursor 문서 열기',
  'settings.engines.cursor.login.title': 'Cursor로 로그인',
  'settings.engines.cursor.login.body': '브라우저에서 Cursor 로그인을 연 다음 여기로 돌아오세요. OpenChamber가 완료될 때까지 폴링합니다.',
  'settings.engines.cursor.login.failed': 'Cursor 로그인에 실패했습니다. 다시 시도하세요.',
  'settings.engines.cursor.login.timeout': 'Cursor 로그인 시간이 초과되었습니다. 다시 시도하세요.',
  'settings.engines.cursor.section.capabilities': '기능',
  'settings.engines.cursor.capabilities.empty': '감지에 성공하면 기능 목록이 표시됩니다.',
  'settings.engines.cursor.capability.full': '완전 지원',
  'settings.engines.cursor.capability.partial': '부분 지원',
  'settings.engines.cursor.capability.none': '사용 불가',
  'settings.engines.cursor.section.warnings': '경고',
  'settings.engines.cursor.warnHandoff.label': 'OpenCode에서 Cursor로 전환할 때 경고',
  'settings.engines.cursor.warnHandoff.aria': 'OpenCode에서 Cursor로 전환할 때 경고',
  'settings.engines.cursor.warnHandoff.info': '새 세션이 OpenCode API 결제가 아닌 Cursor 구독을 사용한다는 점을 설명합니다.',
