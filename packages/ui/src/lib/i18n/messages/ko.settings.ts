...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.usage.overview.period.90d': '90일',
  'settings.usage.overview.period.custom': '사용자 지정',
  'settings.usage.overview.period.fromAria': '기간 시작일',
  'settings.usage.overview.period.toAria': '기간 종료일',
  'settings.usage.overview.history.loading': '사용 기록을 불러오는 중…',
  'settings.usage.overview.history.partial': '일부 세션 기록을 불러오지 못했습니다. 수치가 불완전할 수 있습니다.',
  'settings.usage.overview.history.error': '사용 기록을 불러올 수 없습니다.',
  'settings.usage.overview.providers.other': '기타',
  'settings.usage.overview.providers.noUsage': '이 기간에는 사용량이 없습니다',
  ...
  'settings.usage.overview.metric.vsPrevious': '이전 기간 대비',
