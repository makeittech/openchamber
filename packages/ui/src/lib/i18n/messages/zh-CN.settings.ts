...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.usage.overview.period.custom': '自定义',
  'settings.usage.overview.period.fromAria': '周期开始日期',
  'settings.usage.overview.period.toAria': '周期结束日期',
  'settings.usage.overview.history.loading': '正在加载使用历史…',
  'settings.usage.overview.history.partial': '部分会话历史无法加载，数据可能不完整。',
  'settings.usage.overview.history.error': '无法加载使用历史。',
  'settings.usage.overview.providers.other': '其他',
  'settings.usage.overview.providers.noUsage': '此周期内无用量',
  ...
  'settings.usage.overview.metric.vsPrevious': '较上一周期',
