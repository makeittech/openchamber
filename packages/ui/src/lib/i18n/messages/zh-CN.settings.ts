...
export const settingsDict = {
  ...
  'settings.page.aiWorkflow.title': 'AI 工作流',
...
'settings.harness.claudeCode.warnHandoff.info': '切换 Harness 时，在开始新会话之前显示对话框。关闭后，将在发送下一条消息时静默切换。',
  ...
  'settings.linear.page.tooltip.connectWorkspace': '连接 Linear 工作区，以便从议题启动会话并回传会话状态。',
  'settings.linear.page.label.workspace': '工作区：{value}',
  'settings.linear.page.label.user': '用户：{value}',
  'settings.linear.page.label.scopes': '权限范围：{value}',
  'settings.linear.page.status.connected': '已连接',
  'settings.linear.page.status.notConnected': '未连接',
  'settings.linear.page.status.notConfigured': '服务器上未配置 OAuth 客户端',
  'settings.linear.page.setupHint': '在 Linear 中创建 OAuth 应用（Settings → API → OAuth applications），重定向 URI 填 {redirectUri}，然后设置 OPENCHAMBER_LINEAR_CLIENT_ID 和 OPENCHAMBER_LINEAR_CLIENT_SECRET（或 settings.json 中的 linearClientId/linearClientSecret）。',
  'settings.linear.page.actions.connect': '连接 Linear',
  'settings.linear.page.actions.disconnect': '断开连接',
  'settings.linear.page.flow.waiting': '正在等待浏览器中的授权…',
  'settings.linear.page.flow.cancel': '取消',
  'settings.linear.page.toast.startConnectFailed': '启动 Linear 连接失败',
  'settings.linear.page.toast.connected': 'Linear 已连接',
  'settings.linear.page.toast.disconnected': 'Linear 已断开连接',
  'settings.linear.page.toast.disconnectFailed': '断开 Linear 连接失败',
  'settings.linear.page.status.methodApiKey': '个人 API 密钥',
  'settings.linear.page.status.methodOauth': 'OAuth',
  'settings.linear.page.apiKey.label': '或使用个人 API 密钥连接',
  'settings.linear.page.apiKey.placeholder': 'lin_api_…',
  'settings.linear.page.apiKey.connect': '连接密钥',
  'settings.linear.page.toast.apiKeyConnectFailed': '使用 API 密钥连接失败',
  'settings.linear.page.toast.automationUpdateFailed': '更新 Linear 自动化失败',
  'settings.linear.page.automation.moveToInProgress': '会话开始时将议题移至 In Progress',
  'settings.linear.page.automation.moveToInProgress.info': '当从处于 Triage、Backlog 或 Todo 状态的议题启动 OpenChamber 会话时，该议题将移动到团队的第一个已开始状态。',
  'settings.linear.page.automation.moveToDone': '会话完成时将议题移至 Done',
  'settings.linear.page.automation.moveToDone.info': '默认关闭：当代理进入空闲状态时会话即视为完成，这通常远早于议题实际完成的时间。',
  'settings.cursor.page.title': 'Cursor 云代理',
  'settings.cursor.page.tooltip.connectWorkspace': '连接 Cursor API 密钥，即可从 AI 工作队列启动后台编码代理。',
  'settings.cursor.page.status.connected': '已连接',
  'settings.cursor.page.status.notConnected': '未连接',
  'settings.cursor.page.status.configuredViaEnv': '已通过环境变量配置',
  'settings.cursor.page.apiKey.label': 'Cursor API 密钥',
  'settings.cursor.page.apiKey.placeholder': '粘贴你的 Cursor API 密钥',
  'settings.cursor.page.actions.connect': '连接',
  'settings.cursor.page.actions.disconnect': '断开连接',
  'settings.cursor.page.toast.connected': '已连接 Cursor',
  'settings.cursor.page.toast.connectFailed': '连接 Cursor 失败',
  'settings.cursor.page.toast.disconnected': '已断开 Cursor 连接',
  'settings.cursor.page.toast.disconnectFailed': '断开 Cursor 连接失败',
  'settings.cursor.page.repos.label': '已跟踪的仓库',
  'settings.cursor.page.repos.placeholder': 'owner/repo',
  'settings.cursor.page.repos.add': '添加',
  'settings.cursor.page.repos.empty': '尚未跟踪任何仓库',
  'settings.cursor.page.repos.remove': '移除',
  'settings.cursor.page.toast.reposUpdateFailed': '更新已跟踪仓库失败',
  ...
  'settings.cursor.page.apiVersion.option.v0': 'v0（旧版）',
  'settings.cursor.page.apiVersion.option.v1': 'v1（基于 run）',
  'settings.cursor.page.toast.apiVersionSaved': 'API 版本已保存',
  'settings.cursor.page.toast.apiVersionSaveFailed': '无法保存 API 版本',

  'settings.aiWorkflow.page.section.analysisModel': '默认分析模型',
  'settings.aiWorkflow.page.info.analysisModel': '用于工作队列 issue 和 pull request 的 AI 分析所使用的模型。留空则自动使用你已登录的任意提供方。',
  'settings.aiWorkflow.page.field.analysisModel': '模型',
  'settings.aiWorkflow.page.field.analysisModelAuto': '自动（任意已连接的提供方）',
  'settings.aiWorkflow.page.section.analysisPrompt': '分析提示词',
  'settings.aiWorkflow.page.info.analysisPrompt': '在内置提示词的基础上，附加到每次 AI 分析中的额外说明。',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': '例如：始终将涉及身份验证的内容标记为高优先级。',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': '已解决判定提示词',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': '关于模型应如何判断某个问题是否已被现有提交修复的额外说明。',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': '例如：仅当提交直接修改了受影响的文件时，才将其视为修复。',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': '远程代理提示词',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': '在生成的分析提示词之外，附加到发送给远程编码代理（Cursor）的提示词中的文本。',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': '例如：遵循项目的提交信息和 PR 描述规范。',
  'settings.aiWorkflow.page.toast.saveFailed': '保存 AI 工作流提示词设置失败',
} as const;
