...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.engines.cursor.description': '使用订阅 OAuth 登录的 Cursor 智能体。',
  'settings.engines.cursor.section.status': '状态',
  'settings.engines.cursor.field.status': '状态',
  ...
  'settings.engines.cursor.actions.login': '使用 Cursor 登录',
  'settings.engines.cursor.actions.loginAria': '开始 Cursor 登录',
  'settings.engines.cursor.actions.loginPending': '正在等待登录…',
  'settings.engines.cursor.actions.redetect': '重新检测',
  'settings.engines.cursor.actions.redetectAria': '重新检测 Cursor 状态',
  'settings.engines.cursor.actions.openDocs': '打开文档',
  'settings.engines.cursor.actions.openDocsAria': '打开 Cursor 文档',
  'settings.engines.cursor.login.title': '登录 Cursor',
  'settings.engines.cursor.login.body': '在浏览器中打开 Cursor 登录，然后返回此处。OpenChamber 会轮询直到登录完成。',
  'settings.engines.cursor.login.failed': 'Cursor 登录失败。请重试。',
  'settings.engines.cursor.login.timeout': 'Cursor 登录超时。请重试。',
  'settings.engines.cursor.section.capabilities': '能力',
  'settings.engines.cursor.capabilities.empty': '成功检测后将显示能力列表。',
  'settings.engines.cursor.capability.full': '完全支持',
  'settings.engines.cursor.capability.partial': '部分支持',
  'settings.engines.cursor.capability.none': '不可用',
  'settings.engines.cursor.section.warnings': '警告',
  'settings.engines.cursor.warnHandoff.label': '从 OpenCode 切换到 Cursor 时警告',
  'settings.engines.cursor.warnHandoff.aria': '从 OpenCode 切换到 Cursor 时警告',
  'settings.engines.cursor.warnHandoff.info': '说明新会话使用的是 Cursor 订阅，而不是 OpenCode API 计费。',
