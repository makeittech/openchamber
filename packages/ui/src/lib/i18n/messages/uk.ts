...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.cursorAria": "Рушій Cursor",
  "sessions.sidebar.session.engine.cursorTooltip": "Працює на Cursor",
  ...
  "chat.engines.cursor.notReady": "Cursor не готовий. Відкрийте Налаштування → Рушії, щоб увійти або виявити знову.",
  "chat.engines.cursor.shellUnsupported": "Режим оболонки недоступний у Cursor. Перейдіть на OpenCode або надішліть звичайне повідомлення.",
  "chat.engines.cursor.slashUnsupported": "Команди зі слешем недоступні в Cursor. Перейдіть на OpenCode або надішліть звичайне повідомлення.",
  ...
  "chat.handoff.cursorBillingDialog.title": "Продовжити в Cursor?",
  "chat.handoff.cursorBillingDialog.body": "Це запускає нову сесію в Cursor з використанням вашої підписки Cursor. Провайдери API OpenCode не змінюються. Текст розмови копіюється як контекст; початкова сесія залишається без змін.",
