...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.usage.overview.period.90d': '90 dias',
  'settings.usage.overview.period.custom': 'Personalizado',
  'settings.usage.overview.period.fromAria': 'Data de início do período',
  'settings.usage.overview.period.toAria': 'Data de término do período',
  'settings.usage.overview.history.loading': 'Carregando histórico de uso…',
  'settings.usage.overview.history.partial': 'Parte do histórico de sessões não pôde ser carregada; os valores podem estar incompletos.',
  'settings.usage.overview.history.error': 'Não foi possível carregar o histórico de uso.',
  'settings.usage.overview.providers.other': 'Outros',
  'settings.usage.overview.providers.noUsage': 'Sem uso neste período',
  ...
  "settings.usage.overview.metric.vsPrevious": "vs. período anterior",
