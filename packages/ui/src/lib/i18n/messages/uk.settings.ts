...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.usage.overview.period.90d': '90 днів',
  'settings.usage.overview.period.custom': 'Довільний',
  'settings.usage.overview.period.fromAria': 'Дата початку періоду',
  'settings.usage.overview.period.toAria': 'Дата завершення періоду',
  'settings.usage.overview.history.loading': 'Завантаження історії використання…',
  'settings.usage.overview.history.partial': 'Частину історії сесій не вдалося завантажити; показники можуть бути неповними.',
  'settings.usage.overview.history.error': 'Не вдалося завантажити історію використання.',
  'settings.usage.overview.providers.other': 'Інші',
  'settings.usage.overview.providers.noUsage': 'За цей період використання відсутнє',
  ...
  "settings.usage.overview.metric.vsPrevious": "проти попереднього періоду",
