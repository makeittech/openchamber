...
export const settingsDict = {
  ...
  "settings.page.aiWorkflow.title": "AI-робочий процес",
...
"settings.harness.claudeCode.warnHandoff.info": "Показує діалог перед створенням нової сесії при перемиканні харнесу. Якщо вимкнено, перемикання застосовується тихо з наступним повідомленням.",
  ...
  "settings.linear.page.tooltip.connectWorkspace": "Підключіть робочий простір Linear, щоб запускати сесії з issues і повертати статус сесій назад.",
  "settings.linear.page.label.workspace": "Робочий простір: {value}",
  "settings.linear.page.label.user": "Користувач: {value}",
  "settings.linear.page.label.scopes": "Області доступу: {value}",
  "settings.linear.page.status.connected": "Підключено",
  "settings.linear.page.status.notConnected": "Не підключено",
  "settings.linear.page.status.notConfigured": "OAuth-клієнт не налаштовано на сервері",
  "settings.linear.page.setupHint": "Створіть OAuth-застосунок у Linear (Settings → API → OAuth applications) з redirect URI {redirectUri}, потім задайте OPENCHAMBER_LINEAR_CLIENT_ID і OPENCHAMBER_LINEAR_CLIENT_SECRET (або linearClientId/linearClientSecret у settings.json).",
  "settings.linear.page.actions.connect": "Підключити Linear",
  "settings.linear.page.actions.disconnect": "Відключити",
  "settings.linear.page.flow.waiting": "Очікування авторизації в браузері…",
  "settings.linear.page.flow.cancel": "Скасувати",
  "settings.linear.page.toast.startConnectFailed": "Не вдалося почати підключення Linear",
  "settings.linear.page.toast.connected": "Linear підключено",
  "settings.linear.page.toast.disconnected": "Linear відключено",
  "settings.linear.page.toast.disconnectFailed": "Не вдалося відключити Linear",
  "settings.linear.page.status.methodApiKey": "Особистий API-ключ",
  "settings.linear.page.status.methodOauth": "OAuth",
  "settings.linear.page.apiKey.label": "Або підключіться за допомогою особистого API-ключа",
  "settings.linear.page.apiKey.placeholder": "lin_api_…",
  "settings.linear.page.apiKey.connect": "Підключити ключ",
  "settings.linear.page.toast.apiKeyConnectFailed": "Не вдалося підключитися за допомогою API-ключа",
  "settings.linear.page.toast.automationUpdateFailed": "Не вдалося оновити автоматизацію Linear",
  "settings.linear.page.automation.moveToInProgress": "Переміщувати issue в «In Progress» при старті сесії",
  "settings.linear.page.automation.moveToInProgress.info": "Коли сесію OpenChamber запущено з issue у Triage, Backlog або Todo, issue переміщується в перший стан «started» команди.",
  "settings.linear.page.automation.moveToDone": "Переміщувати issue в «Done» після завершення сесії",
  "settings.linear.page.automation.moveToDone.info": "Вимкнено за замовчуванням: сесія вважається завершеною, щойно агент переходить у стан очікування, а це зазвичай трапляється задовго до фактичного виконання issue.",
  "settings.cursor.page.title": "Cursor Cloud Agents",
  "settings.cursor.page.tooltip.connectWorkspace": "Підключіть API-ключ Cursor, щоб запускати фонових кодувальних агентів із черги завдань ШІ.",
  "settings.cursor.page.status.connected": "Підключено",
  "settings.cursor.page.status.notConnected": "Не підключено",
  "settings.cursor.page.status.configuredViaEnv": "Налаштовано через змінну середовища",
  "settings.cursor.page.apiKey.label": "API-ключ Cursor",
  "settings.cursor.page.apiKey.placeholder": "Вставте свій API-ключ Cursor",
  "settings.cursor.page.actions.connect": "Підключити",
  "settings.cursor.page.actions.disconnect": "Відключити",
  "settings.cursor.page.toast.connected": "Cursor підключено",
  "settings.cursor.page.toast.connectFailed": "Не вдалося підключити Cursor",
  "settings.cursor.page.toast.disconnected": "Cursor відключено",
  "settings.cursor.page.toast.disconnectFailed": "Не вдалося відключити Cursor",
  "settings.cursor.page.repos.label": "Відстежувані репозиторії",
  "settings.cursor.page.repos.placeholder": "owner/repo",
  "settings.cursor.page.repos.add": "Додати",
  "settings.cursor.page.repos.empty": "Ще немає відстежуваних репозиторіїв",
  "settings.cursor.page.repos.remove": "Видалити",
  "settings.cursor.page.toast.reposUpdateFailed": "Не вдалося оновити відстежувані репозиторії",
  'settings.cursor.page.apiVersion.label': 'Версія API',
  'settings.cursor.page.apiVersion.controlledByEnv': 'Керується через OPENCHAMBER_CURSOR_API_VERSION',
  'settings.cursor.page.apiVersion.option.v0': 'v0 (застаріла)',
  'settings.cursor.page.apiVersion.option.v1': 'v1 (на основі run)',
  'settings.cursor.page.toast.apiVersionSaved': 'Версію API збережено',
  'settings.cursor.page.toast.apiVersionSaveFailed': 'Не вдалося зберегти версію API',

  'settings.aiWorkflow.page.section.analysisModel': 'Типова модель аналізу',
  'settings.aiWorkflow.page.info.analysisModel': 'Модель, яка використовується для AI-аналізу issue та pull request у черзі завдань. Залиште порожнім, щоб автоматично використовувати будь-якого провайдера, до якого ви увійшли.',
  'settings.aiWorkflow.page.field.analysisModel': 'Модель',
  'settings.aiWorkflow.page.field.analysisModelAuto': 'Автоматично (будь-який підключений провайдер)',
  'settings.aiWorkflow.page.section.analysisPrompt': 'Промпт аналізу',
  'settings.aiWorkflow.page.info.analysisPrompt': 'Додаткові інструкції, які додаються до кожного проходу AI-аналізу на додачу до вбудованого промпту.',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': 'напр. Завжди позначай усе, що стосується автентифікації, як високий пріоритет.',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': 'Промпт «вже вирішено»',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': 'Додаткові інструкції щодо того, як модель має визначати, чи проблему вже виправлено наявним комітом.',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': 'напр. Вважай коміт виправленням лише якщо він безпосередньо змінює відповідний файл.',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': 'Промпт віддаленого агента',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': 'Текст, який додається до промпту, що надсилається віддаленому агенту для кодування (Cursor), на додачу до згенерованого промпту аналізу.',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': 'напр. Дотримуйся прийнятих у проєкті конвенцій для повідомлень комітів і описів PR.',
  'settings.aiWorkflow.page.toast.saveFailed': 'Не вдалося зберегти налаштування промптів AI-робочого процесу',
} as const;
