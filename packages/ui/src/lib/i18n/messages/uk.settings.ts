...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.engines.cursor.description": "Агент Cursor із входом OAuth за підпискою.",
  "settings.engines.cursor.section.status": "Статус",
  "settings.engines.cursor.field.status": "Статус",
  "settings.engines.cursor.field.version": "Версія",
  "settings.engines.cursor.status.version": "{version}",
  "settings.engines.cursor.status.versionUnknown": "Невідома",
  "settings.engines.cursor.actions.login": "Увійти через Cursor",
  "settings.engines.cursor.actions.loginAria": "Почати вхід у Cursor",
  "settings.engines.cursor.actions.loginPending": "Очікування входу…",
  "settings.engines.cursor.actions.redetect": "Перевірити знову",
  "settings.engines.cursor.actions.redetectAria": "Повторно визначити статус Cursor",
  "settings.engines.cursor.actions.openDocs": "Відкрити документацію",
  "settings.engines.cursor.actions.openDocsAria": "Відкрити документацію Cursor",
  "settings.engines.cursor.login.title": "Увійти в Cursor",
  "settings.engines.cursor.login.body": "Відкрийте вхід Cursor у браузері, потім поверніться сюди. OpenChamber опитуватиме, доки вхід не завершиться.",
  "settings.engines.cursor.login.failed": "Не вдалося увійти в Cursor. Спробуйте ще раз.",
  "settings.engines.cursor.login.timeout": "Час очікування входу в Cursor минув. Спробуйте ще раз.",
  "settings.engines.cursor.section.capabilities": "Можливості",
  "settings.engines.cursor.capabilities.empty": "Можливості з’являться після успішного визначення.",
  "settings.engines.cursor.capability.full": "Повністю",
  "settings.engines.cursor.capability.partial": "Частково",
  "settings.engines.cursor.capability.none": "Недоступно",
  "settings.engines.cursor.section.warnings": "Попередження",
  "settings.engines.cursor.warnHandoff.label": "Попереджати під час переходу з OpenCode на Cursor",
  "settings.engines.cursor.warnHandoff.aria": "Попереджати під час переходу з OpenCode на Cursor",
  "settings.engines.cursor.warnHandoff.info": "Пояснює, що нова сесія використовує вашу підписку Cursor, а не оплату через API OpenCode.",
