...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.harness.slashUnsupported': 'To polecenie slash OpenCode nie jest dostępne w Claude Code. Użyj natywnego polecenia / Claude albo wyślij zwykłą wiadomość.',
