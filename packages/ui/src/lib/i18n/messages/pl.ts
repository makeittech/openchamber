...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.workQueue': 'Kolejka zadań AI',
  'workQueue.unavailable': 'Kolejka zadań AI jest niedostępna w tym środowisku',
  'workQueue.window.description': 'Kolejka zadań AI: analiza zgłoszeń GitHub i Linear generowana przez AI',
  'workQueue.view.board': 'Tablica',
  'workQueue.view.matrix': 'Macierz',
  'workQueue.view.list': 'Lista',
  'workQueue.view.calendar': 'Kalendarz',
  'workQueue.view.comingSoon': 'Wkrótce',
  'workQueue.nav.queue': 'Kolejka',
  'workQueue.nav.recommended': 'Polecane',
  'workQueue.nav.critical': 'Krytyczne',
  'workQueue.nav.in_progress': 'W trakcie',
  'workQueue.nav.cloud_agents': 'Agenci w chmurze',
  'workQueue.nav.done': 'Ukończone',
  'workQueue.nav.repositories': 'Repozytoria',
  'workQueue.toolbar.searchPlaceholder': 'Szukaj zadań, repozytoriów, autorów...',

  'workQueue.toolbar.filters': 'Filtry',
  'workQueue.toolbar.sync': 'Synchronizuj',
  'workQueue.toolbar.filterAll': 'Wszystkie',
  'workQueue.toolbar.filterRepo': 'Repozytorium',
  'workQueue.toolbar.filterAssignee': 'Przypisany',
  'workQueue.toolbar.filterType': 'Typ',
  'workQueue.toolbar.filterPriority': 'Priorytet',
  'workQueue.toolbar.filterComplexity': 'Trudność',
  'workQueue.toolbar.resetFilters': 'Resetuj filtry',
  'workQueue.type.issue': 'Zgłoszenie',
  'workQueue.type.pr': 'Pull request',
  'workQueue.issueType.bug': 'Błąd',
  'workQueue.issueType.feature': 'Funkcja',
  'workQueue.issueType.enhancement': 'Usprawnienie',
  'workQueue.issueType.question': 'Pytanie',
  'workQueue.issueType.documentation': 'Dokumentacja',
  'workQueue.priority.critical': 'Krytyczny',
  'workQueue.priority.high': 'Wysoki',
  'workQueue.priority.medium': 'Średni',
  'workQueue.priority.low': 'Niski',
  'workQueue.complexity.easy': 'Łatwe',
  'workQueue.complexity.medium': 'Średnie',
  'workQueue.complexity.hard': 'Trudne',
  'workQueue.complexity.huge': 'Bardzo trudne',
  'workQueue.env.headless': 'Wymaga środowiska headless',
  'workQueue.env.browser': 'Wymaga przeglądarki',
  'workQueue.env.docker': 'Wymaga Dockera',
  'workQueue.status.todo': 'Do zrobienia',
  'workQueue.status.in_progress': 'W trakcie',
  'workQueue.status.backlog': 'Zaległości',
  'workQueue.status.done': 'Ukończone',
  'workQueue.board.toast.linearSyncFailed': 'Zapisano lokalnie — synchronizacja z Linear nie powiodła się',
  'workQueue.board.toast.assigneeSyncFailed': 'Zapisano lokalnie — nie udało się przypisać zgłoszenia do Ciebie',
  'workQueue.board.emptyColumn': 'Upuść zadanie tutaj',
  'workQueue.list.empty': 'Żadne zadanie nie pasuje do bieżących filtrów',
  'workQueue.card.estimateMinutes': '{minutes} min',
  'workQueue.card.confidence': 'Pewność {confidence}%',
  'workQueue.card.notAnalyzed': 'Jeszcze nie przeanalizowano',
  'workQueue.card.analysisError': 'Analiza nie powiodła się',
  'workQueue.card.analyze': 'Przeanalizuj z AI',
  'workQueue.card.reanalyze': 'Przeanalizuj ponownie',
  'workQueue.card.analyzing': 'Analizowanie…',
  'workQueue.detail.close': 'Zamknij',
  'workQueue.detail.tab.overview': 'Przegląd',
  'workQueue.detail.tab.analysis': 'Analiza AI',
  'workQueue.detail.field.priority': 'Priorytet',
  'workQueue.detail.field.complexity': 'Złożoność',
  'workQueue.detail.field.confidence': 'Pewność AI',
  'workQueue.detail.field.estimate': 'Szacowany czas',
  'workQueue.detail.field.environment': 'Środowisko',
  'workQueue.detail.field.author': 'Autor',
  'workQueue.detail.field.labels': 'Etykiety',
  'workQueue.detail.field.generatedPrompt': 'Wygenerowany prompt',
  'workQueue.detail.cloudAgentStatus': 'Agent w chmurze: {status}',
  'workQueue.detail.actions.take': 'Weź zadanie',
  'workQueue.detail.actions.openInOpenChamber': 'Otwórz w OpenChamber',
  'workQueue.detail.actions.cloudAgent': 'Wyślij do agenta w chmurze',
  'workQueue.detail.actions.openCloudAgent': 'Zobacz przebieg agenta',
  'workQueue.detail.actions.copyPrompt': 'Kopiuj prompt',
  'workQueue.detail.actions.openGitHub': 'Otwórz w GitHub',
  'workQueue.detail.actions.openLinear': 'Otwórz w Linear',
  'workQueue.detail.actions.finish': 'Zakończ',
  'workQueue.detail.actions.analyze': 'Analizuj',
  'workQueue.detail.actions.reanalyze': 'Przeanalizuj ponownie',
  'workQueue.detail.error.noActiveProject': 'Nie wybrano aktywnego projektu',
  'workQueue.detail.toast.analyzeFailed': 'Analiza nie powiodła się',
  'workQueue.detail.toast.promptCopied': 'Prompt skopiowany do schowka',
  'workQueue.detail.toast.copyFailed': 'Nie udało się skopiować promptu',
  'workQueue.detail.toast.cloudAgentFailed': 'Nie udało się uruchomić agenta w chmurze',
  'workQueue.detail.toast.finished': 'Zadanie zakończone i zarchiwizowane',
  'workQueue.detail.toast.finishIncomplete': 'Zakończenie się nie powiodło — sprawdź status GitHub/Linear',
  'workQueue.detail.tab.review': 'Recenzja AI',
  'workQueue.detail.field.description': 'Opis',

  'workQueue.detail.field.created': 'Utworzono',
  'workQueue.detail.noDescription': 'Brak opisu',
  'workQueue.detail.review.empty': 'Brak komentarzy z automatycznej recenzji',
  'workQueue.detail.toast.cloudAgentLaunched': 'Uruchomiono agenta w chmurze',
  'workQueue.toolbar.analyzeAll': 'Analizuj wszystko',
  'workQueue.toolbar.analyzeAllWithCount': 'Analizuj wszystko ({count})',
  'workQueue.toolbar.sortLabel': 'Sortowanie',
  'workQueue.toolbar.sortDefault': 'Domyślnie',
  'workQueue.toolbar.sortNewest': 'Najpierw najnowsze',
  'workQueue.toolbar.sortOldest': 'Najpierw najstarsze',
  'workQueue.toolbar.sortCriticality': 'Wg krytyczności',
  'workQueue.toolbar.sortBugs': 'Najpierw błędy',
  'workQueue.toolbar.sortFeatures': 'Najpierw funkcje',
  'workQueue.toolbar.toast.bulkAnalyzeDone': 'Przeanalizowano zadania: {done}',
  'workQueue.toolbar.toast.bulkAnalyzePartial': 'Przeanalizowano {done}, niepowodzeń: {failed}',
  'workQueue.toolbar.toast.bulkAnalyzeFailed': 'Analiza zbiorcza nie powiodła się',
  'workQueue.board.toast.linearCreateFailed': 'Zapisano lokalnie — nie udało się utworzyć zgłoszenia w Linear',
  'workQueue.detail.analysis.alreadySolvedTitle': 'Możliwe, że już rozwiązane',
  'workQueue.detail.analysis.alreadySolvedEvidence': 'Znaleziono w commicie {hash} — „{message}”',
  'workQueue.detail.analysis.duplicateTitle': 'Możliwy duplikat',
  'workQueue.detail.analysis.duplicateOf': 'Prawdopodobnie ten sam problem co „{title}”',
  'workQueue.detail.actions.viewDuplicate': 'Zobacz oryginał',
  'workQueue.detail.finishDialog.title': 'Zakończ zadanie',
  'workQueue.detail.finishDialog.description': 'Wybierz sposób zamknięcia tego zadania.',
  'workQueue.detail.finishDialog.reason.completed': 'Oznacz jako ukończone',
  'workQueue.detail.finishDialog.reason.duplicate': 'Zamknij jako duplikat',
  'workQueue.detail.finishDialog.reason.notPlanned': 'Zamknij jako nieplanowane',
  'workQueue.detail.finishDialog.duplicateOfLabel': 'Duplikat (URL)',
  'workQueue.detail.finishDialog.duplicateOfPlaceholder': 'https://github.com/... lub URL zgłoszenia Linear',
  'workQueue.detail.finishDialog.cancel': 'Anuluj',
  'workQueue.detail.finishDialog.confirm': 'Zamknij zadanie',
  'workQueue.detail.toast.closedDuplicate': 'Zamknięto jako duplikat',
  'workQueue.detail.toast.closedNotPlanned': 'Zamknięto jako nieplanowane',
  'workQueue.detail.field.manualEvidence': 'Dowód ręczny',
  'workQueue.detail.actions.checkStaleness': 'Sprawdź historię commitów',
  'workQueue.detail.staleness.match': 'Znaleziono w commicie {hash} — „{message}”',
  'workQueue.detail.staleness.noMatches': 'Nie znaleziono pasujących commitów',
  'workQueue.detail.field.attachedPr': 'Dołączony PR',
  'workQueue.detail.toast.stalenessCheckFailed': 'Nie udało się sprawdzić historii commitów',
  'workQueue.detail.toast.prAttached': 'Dołączono PR',
  'workQueue.detail.toast.prAttachFailed': 'Nie udało się dołączyć PR',
  'workQueue.detail.field.analysisModel': 'Model analizy',
  'workQueue.detail.analysis.modelAuto': 'Automatycznie (dowolny połączony dostawca)',
  'workQueue.detail.analysis.setDefaultModel': 'Ustaw jako model domyślny',
  'workQueue.detail.analysis.isDefaultModel': 'Domyślny model do analizy',
  'workQueue.detail.toast.defaultModelSet': 'Zaktualizowano domyślny model analizy',
  'workQueue.detail.toast.defaultModelSetFailed': 'Nie udało się zaktualizować domyślnego modelu analizy',
  'workQueue.cloudAgent.dialog.title': 'Wyślij do agenta w chmurze',
  'workQueue.cloudAgent.dialog.description': 'Sprawdź prompt i model przed uruchomieniem agenta Cursor w tle.',
  'workQueue.cloudAgent.dialog.notConnected': 'Cursor nie jest połączony — najpierw dodaj klucz API w Ustawieniach.',
  'workQueue.cloudAgent.dialog.repository': 'Repozytorium',
  'workQueue.cloudAgent.dialog.model': 'Model',
  'workQueue.cloudAgent.dialog.prompt': 'Prompt',
  'workQueue.cloudAgent.dialog.send': 'Wyślij',

  'workQueue.cloudAgent.popup.title': 'Agent uruchomiony',
  'workQueue.cloudAgent.popup.description': 'Agent pracuje teraz nad tym zadaniem w tle. Otwórz przebieg, aby śledzić postępy.',
  'workQueue.cloudAgent.popup.openRun': 'Otwórz przebieg',
  'workQueue.cloudAgent.popup.close': 'Nie teraz',
  'workQueue.cloudAgent.dialog.cancel': 'Anuluj',
} as const;
