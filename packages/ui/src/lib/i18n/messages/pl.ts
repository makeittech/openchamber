...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.cursorAria': 'Silnik Cursor',
  'sessions.sidebar.session.engine.cursorTooltip': 'Działa na Cursor',
  ...
  'chat.engines.cursor.notReady': 'Cursor nie jest gotowy. Otwórz Ustawienia → Silniki, aby się zalogować lub wykryć ponownie.',
  'chat.engines.cursor.shellUnsupported': 'Tryb powłoki nie jest dostępny w Cursor. Przełącz na OpenCode lub wyślij zwykłą wiadomość.',
  'chat.engines.cursor.slashUnsupported': 'Polecenia z ukośnikiem nie są dostępne w Cursor. Przełącz na OpenCode lub wyślij zwykłą wiadomość.',
  ...
  'chat.handoff.cursorBillingDialog.title': 'Kontynuować w Cursor?',
  'chat.handoff.cursorBillingDialog.body': 'To rozpoczyna nową sesję w Cursor z użyciem subskrypcji Cursor. Dostawcy API OpenCode pozostają bez zmian. Tekst rozmowy jest kopiowany jako kontekst; oryginalna sesja pozostaje nietknięta.',
