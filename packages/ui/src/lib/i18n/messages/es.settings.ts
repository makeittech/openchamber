...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.usage.overview.period.90d': '90 días',
  'settings.usage.overview.period.custom': 'Personalizado',
  'settings.usage.overview.period.fromAria': 'Fecha de inicio del periodo',
  'settings.usage.overview.period.toAria': 'Fecha de fin del periodo',
  'settings.usage.overview.history.loading': 'Cargando historial de uso…',
  'settings.usage.overview.history.partial': 'No se pudo cargar parte del historial de sesiones; las cifras pueden estar incompletas.',
  'settings.usage.overview.history.error': 'No se pudo cargar el historial de uso.',
  'settings.usage.overview.providers.other': 'Otros',
  'settings.usage.overview.providers.noUsage': 'Sin uso en este periodo',
  ...
  "settings.usage.overview.metric.vsPrevious": "vs. periodo anterior",
