...
export const settingsDict = {
  ...
  "settings.page.aiWorkflow.title": "Flujo de trabajo de IA",
...
"settings.harness.claudeCode.warnHandoff.info": "Muestra un diálogo antes de iniciar una nueva sesión al cambiar de harness. Si está desactivado, el cambio se aplica silenciosamente con tu próximo mensaje.",
  ...
  "settings.linear.page.tooltip.connectWorkspace": "Conecta un espacio de trabajo de Linear para iniciar sesiones desde issues e informar el estado de la sesión de vuelta.",
  "settings.linear.page.label.workspace": "Espacio de trabajo: {value}",
  "settings.linear.page.label.user": "Usuario: {value}",
  "settings.linear.page.label.scopes": "Ámbitos: {value}",
  "settings.linear.page.status.connected": "Conectado",
  "settings.linear.page.status.notConnected": "No conectado",
  "settings.linear.page.status.notConfigured": "El cliente OAuth no está configurado en el servidor",
  "settings.linear.page.setupHint": "Crea una aplicación OAuth en Linear (Settings → API → OAuth applications) con el URI de redirección {redirectUri}, luego define OPENCHAMBER_LINEAR_CLIENT_ID y OPENCHAMBER_LINEAR_CLIENT_SECRET (o linearClientId/linearClientSecret en settings.json).",
  "settings.linear.page.actions.connect": "Conectar Linear",
  "settings.linear.page.actions.disconnect": "Desconectar",
  "settings.linear.page.flow.waiting": "Esperando autorización en el navegador…",
  "settings.linear.page.flow.cancel": "Cancelar",
  "settings.linear.page.toast.startConnectFailed": "No se pudo iniciar la conexión con Linear",
  "settings.linear.page.toast.connected": "Linear conectado",
  "settings.linear.page.toast.disconnected": "Linear desconectado",
  "settings.linear.page.toast.disconnectFailed": "No se pudo desconectar Linear",
  "settings.linear.page.status.methodApiKey": "Clave de API personal",
  "settings.linear.page.status.methodOauth": "OAuth",
  "settings.linear.page.apiKey.label": "O conecta con una clave de API personal",
  "settings.linear.page.apiKey.placeholder": "lin_api_…",
  "settings.linear.page.apiKey.connect": "Conectar clave",
  "settings.linear.page.toast.apiKeyConnectFailed": "No se pudo conectar con la clave de API",
  "settings.linear.page.toast.automationUpdateFailed": "No se pudo actualizar la automatización de Linear",
  "settings.linear.page.automation.moveToInProgress": "Mover el issue a «En curso» al iniciar una sesión",
  "settings.linear.page.automation.moveToInProgress.info": "Cuando se inicia una sesión de OpenChamber desde un issue en Triage, Backlog o Todo, el issue pasa al primer estado «iniciado» del equipo.",
  "settings.linear.page.automation.moveToDone": "Mover el issue a «Hecho» al completar una sesión",
  "settings.linear.page.automation.moveToDone.info": "Desactivado por defecto: una sesión se considera completada en cuanto el agente queda inactivo, lo cual suele ocurrir mucho antes de que el issue esté realmente resuelto.",
  "settings.cursor.page.title": "Cursor Cloud Agents",
  "settings.cursor.page.tooltip.connectWorkspace": "Conecta una clave de API de Cursor para lanzar agentes de codificación en segundo plano desde la cola de trabajo de IA.",
  "settings.cursor.page.status.connected": "Conectado",
  "settings.cursor.page.status.notConnected": "No conectado",
  "settings.cursor.page.status.configuredViaEnv": "Configurado mediante variable de entorno",
  "settings.cursor.page.apiKey.label": "Clave de API de Cursor",
  "settings.cursor.page.apiKey.placeholder": "Pega tu clave de API de Cursor",
  "settings.cursor.page.actions.connect": "Conectar",
  "settings.cursor.page.actions.disconnect": "Desconectar",
  "settings.cursor.page.toast.connected": "Cursor conectado",
  "settings.cursor.page.toast.connectFailed": "No se pudo conectar Cursor",
  "settings.cursor.page.toast.disconnected": "Cursor desconectado",
  "settings.cursor.page.toast.disconnectFailed": "No se pudo desconectar Cursor",
  "settings.cursor.page.repos.label": "Repositorios seguidos",
  "settings.cursor.page.repos.placeholder": "owner/repo",
  "settings.cursor.page.repos.add": "Añadir",
  "settings.cursor.page.repos.empty": "Aún no hay repositorios seguidos",
  "settings.cursor.page.repos.remove": "Eliminar",
  "settings.cursor.page.toast.reposUpdateFailed": "No se pudieron actualizar los repositorios seguidos",
  'settings.cursor.page.apiVersion.label': 'Versión de la API',
  'settings.cursor.page.apiVersion.controlledByEnv': 'Controlado por OPENCHAMBER_CURSOR_API_VERSION',
  'settings.cursor.page.apiVersion.option.v0': 'v0 (heredada)',
  'settings.cursor.page.apiVersion.option.v1': 'v1 (basada en runs)',
  'settings.cursor.page.toast.apiVersionSaved': 'Versión de la API guardada',
  'settings.cursor.page.toast.apiVersionSaveFailed': 'Error al guardar la versión de la API',

  'settings.aiWorkflow.page.section.analysisModel': 'Modelo de análisis predeterminado',
  'settings.aiWorkflow.page.info.analysisModel': 'Modelo usado para el análisis de IA de issues y pull requests de la cola de trabajo. Déjalo sin definir para usar automáticamente cualquier proveedor con el que hayas iniciado sesión.',
  'settings.aiWorkflow.page.field.analysisModel': 'Modelo',
  'settings.aiWorkflow.page.field.analysisModelAuto': 'Automático (cualquier proveedor conectado)',
  'settings.aiWorkflow.page.section.analysisPrompt': 'Prompt de análisis',
  'settings.aiWorkflow.page.info.analysisPrompt': 'Instrucciones adicionales que se añaden a cada análisis de IA, además del prompt integrado.',
  'settings.aiWorkflow.page.field.analysisPromptPlaceholder': 'p. ej. Marca siempre como alta prioridad cualquier cosa relacionada con la autenticación.',
  'settings.aiWorkflow.page.section.alreadySolvedPrompt': 'Prompt de "ya resuelto"',
  'settings.aiWorkflow.page.info.alreadySolvedPrompt': 'Instrucciones adicionales sobre cómo debe juzgar el modelo si un problema ya está solucionado por un commit existente.',
  'settings.aiWorkflow.page.field.alreadySolvedPromptPlaceholder': 'p. ej. Solo considera un commit como solución si modifica directamente el archivo afectado.',
  'settings.aiWorkflow.page.section.remoteAgentPrompt': 'Prompt del agente remoto',
  'settings.aiWorkflow.page.info.remoteAgentPrompt': 'Texto que se añade al prompt enviado a un agente de código remoto (Cursor), además del prompt de análisis generado.',
  'settings.aiWorkflow.page.field.remoteAgentPromptPlaceholder': 'p. ej. Sigue las convenciones del proyecto para mensajes de commit y descripciones de PR.',
  'settings.aiWorkflow.page.toast.saveFailed': 'No se pudo guardar la configuración de prompts de Flujo de trabajo de IA',
} as const;
