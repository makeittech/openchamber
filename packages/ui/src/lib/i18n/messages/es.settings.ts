...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.engines.sidebar.engine.cursor": "Cursor",
  ...
  "settings.engines.cursor.title": "Cursor",
  "settings.engines.cursor.description": "Agente de Cursor con inicio de sesión OAuth de suscripción.",
  "settings.engines.cursor.section.status": "Estado",
  "settings.engines.cursor.field.status": "Estado",
  "settings.engines.cursor.field.version": "Versión",
  "settings.engines.cursor.status.version": "{version}",
  "settings.engines.cursor.status.versionUnknown": "Desconocida",
  "settings.engines.cursor.actions.login": "Iniciar sesión con Cursor",
  "settings.engines.cursor.actions.loginAria": "Iniciar el inicio de sesión de Cursor",
  "settings.engines.cursor.actions.loginPending": "Esperando el inicio de sesión…",
  "settings.engines.cursor.actions.redetect": "Volver a detectar",
  "settings.engines.cursor.actions.redetectAria": "Volver a detectar el estado de Cursor",
  "settings.engines.cursor.actions.openDocs": "Abrir documentación",
  "settings.engines.cursor.actions.openDocsAria": "Abrir la documentación de Cursor",
  "settings.engines.cursor.login.title": "Iniciar sesión con Cursor",
  "settings.engines.cursor.login.body": "Abre el inicio de sesión de Cursor en el navegador y vuelve aquí. OpenChamber consulta hasta que se complete.",
  "settings.engines.cursor.login.failed": "Error al iniciar sesión en Cursor. Inténtalo de nuevo.",
  "settings.engines.cursor.login.timeout": "Se agotó el tiempo de inicio de sesión de Cursor. Inténtalo de nuevo.",
  "settings.engines.cursor.section.capabilities": "Capacidades",
  "settings.engines.cursor.capabilities.empty": "Las capacidades aparecen tras una detección correcta.",
  "settings.engines.cursor.capability.full": "Completo",
  "settings.engines.cursor.capability.partial": "Parcial",
  "settings.engines.cursor.capability.none": "No disponible",
  "settings.engines.cursor.section.warnings": "Avisos",
  "settings.engines.cursor.warnHandoff.label": "Avisar al cambiar de OpenCode a Cursor",
  "settings.engines.cursor.warnHandoff.aria": "Avisar al cambiar de OpenCode a Cursor",
  "settings.engines.cursor.warnHandoff.info": "Explica que la nueva sesión usa tu suscripción de Cursor, no la facturación de API de OpenCode.",
