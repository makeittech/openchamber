...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.cursorAria': 'Cursor 引擎',
  'sessions.sidebar.session.engine.cursorTooltip': '正在 Cursor 上執行',
  ...
  'chat.engines.cursor.notReady': 'Cursor 尚未就緒。請開啟設定 → 引擎以登入或重新偵測。',
  'chat.engines.cursor.shellUnsupported': 'Cursor 不支援 Shell 模式。請切換到 OpenCode，或傳送一般訊息。',
  'chat.engines.cursor.slashUnsupported': 'Cursor 不支援斜線指令。請切換到 OpenCode，或傳送一般訊息。',
  ...
  'chat.handoff.cursorBillingDialog.title': '要在 Cursor 上繼續嗎？',
  'chat.handoff.cursorBillingDialog.body': '這會使用你的 Cursor 訂閱開始新工作階段。OpenCode API 供應商維持不變。對話文字會複製為脈絡；原始工作階段保持不變。',
