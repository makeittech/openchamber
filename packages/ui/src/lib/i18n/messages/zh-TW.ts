...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.footer.actions.workQueue': 'AI 工作佇列',
  'workQueue.unavailable': '此執行環境不支援 AI 工作佇列',
  'workQueue.window.description': 'AI 工作佇列：由 AI 產生的 GitHub 與 Linear 問題分析',
  'workQueue.view.board': '看板',
  'workQueue.view.matrix': '矩陣',
  'workQueue.view.list': '清單',
  'workQueue.view.calendar': '行事曆',
  'workQueue.view.comingSoon': '即將推出',
  'workQueue.nav.queue': '佇列',
  'workQueue.nav.recommended': '推薦',
  'workQueue.nav.critical': '嚴重',
  'workQueue.nav.in_progress': '進行中',
  'workQueue.nav.cloud_agents': '雲端代理',
  'workQueue.nav.done': '已完成',
  'workQueue.nav.repositories': '儲存庫',
  'workQueue.toolbar.searchPlaceholder': '搜尋任務、儲存庫、作者...',

  'workQueue.toolbar.filters': '篩選',
  'workQueue.toolbar.sync': '同步',
  'workQueue.toolbar.filterAll': '全部',
  'workQueue.toolbar.filterRepo': '儲存庫',
  'workQueue.toolbar.filterAssignee': '負責人',
  'workQueue.toolbar.filterType': '類型',
  'workQueue.toolbar.filterPriority': '優先順序',
  'workQueue.toolbar.filterComplexity': '難度',
  'workQueue.toolbar.resetFilters': '重設篩選',
  'workQueue.type.issue': '議題',
  'workQueue.type.pr': '提取請求',
  'workQueue.issueType.bug': '缺陷',
  'workQueue.issueType.feature': '功能',
  'workQueue.issueType.enhancement': '增強',
  'workQueue.issueType.question': '問題諮詢',
  'workQueue.issueType.documentation': '文件',
  'workQueue.priority.critical': '嚴重',
  'workQueue.priority.high': '高',
  'workQueue.priority.medium': '中',
  'workQueue.priority.low': '低',
  'workQueue.complexity.easy': '簡單',
  'workQueue.complexity.medium': '中等',
  'workQueue.complexity.hard': '困難',
  'workQueue.complexity.huge': '非常困難',
  'workQueue.env.headless': '需要 headless 環境',
  'workQueue.env.browser': '需要瀏覽器',
  'workQueue.env.docker': '需要 Docker',
  'workQueue.status.todo': '待辦',
  'workQueue.status.in_progress': '進行中',
  'workQueue.status.backlog': '需求庫',
  'workQueue.status.done': '已完成',
  'workQueue.board.toast.linearSyncFailed': '已在本機儲存 — Linear 同步失敗',
  'workQueue.board.toast.assigneeSyncFailed': '已在本機儲存 — 無法將此項目指派給你',
  'workQueue.board.emptyColumn': '將任務拖放到這裡',
  'workQueue.list.empty': '沒有任務符合目前的篩選條件',
  'workQueue.card.estimateMinutes': '{minutes} 分鐘',
  'workQueue.card.confidence': '信心度 {confidence}%',
  'workQueue.card.notAnalyzed': '尚未分析',
  'workQueue.card.analysisError': '分析失敗',
  'workQueue.card.analyze': '使用 AI 分析',
  'workQueue.card.reanalyze': '重新分析',
  'workQueue.card.analyzing': '分析中…',
  'workQueue.detail.close': '關閉',
  'workQueue.detail.tab.overview': '概覽',
  'workQueue.detail.tab.analysis': 'AI 分析',
  'workQueue.detail.field.priority': '優先順序',
  'workQueue.detail.field.complexity': '複雜度',
  'workQueue.detail.field.confidence': 'AI 信心度',
  'workQueue.detail.field.estimate': '預估時間',
  'workQueue.detail.field.environment': '環境',
  'workQueue.detail.field.author': '作者',
  'workQueue.detail.field.labels': '標籤',
  'workQueue.detail.field.generatedPrompt': '產生的提示詞',
  'workQueue.detail.cloudAgentStatus': '雲端代理：{status}',
  'workQueue.detail.actions.take': '認領任務',
  'workQueue.detail.actions.openInOpenChamber': '在 OpenChamber 中開啟',
  'workQueue.detail.actions.cloudAgent': '傳送給雲端代理',
  'workQueue.detail.actions.openCloudAgent': '查看代理執行狀態',
  'workQueue.detail.actions.copyPrompt': '複製提示詞',
  'workQueue.detail.actions.openGitHub': '在 GitHub 中開啟',
  'workQueue.detail.actions.openLinear': '在 Linear 中開啟',
  'workQueue.detail.actions.finish': '完成',
  'workQueue.detail.actions.analyze': '分析',
  'workQueue.detail.actions.reanalyze': '重新分析',
  'workQueue.detail.error.noActiveProject': '未選擇使用中的專案',
  'workQueue.detail.toast.analyzeFailed': '分析失敗',
  'workQueue.detail.toast.promptCopied': '提示詞已複製到剪貼簿',
  'workQueue.detail.toast.copyFailed': '複製提示詞失敗',
  'workQueue.detail.toast.cloudAgentFailed': '無法啟動雲端代理',
  'workQueue.detail.toast.finished': '任務已完成並封存',
  'workQueue.detail.toast.finishIncomplete': '未能完成 — 請檢查 GitHub/Linear 狀態',
  'workQueue.detail.tab.review': 'AI 審查',
  'workQueue.detail.field.description': '描述',

  'workQueue.detail.field.created': '建立時間',
  'workQueue.detail.noDescription': '未提供描述',
  'workQueue.detail.review.empty': '尚無自動審查評論',
  'workQueue.detail.toast.cloudAgentLaunched': '雲端代理已啟動',
  'workQueue.toolbar.analyzeAll': '全部分析',
  'workQueue.toolbar.analyzeAllWithCount': '全部分析（{count}）',
  'workQueue.toolbar.sortLabel': '排序',
  'workQueue.toolbar.sortDefault': '預設',
  'workQueue.toolbar.sortNewest': '最新優先',
  'workQueue.toolbar.sortOldest': '最舊優先',
  'workQueue.toolbar.sortCriticality': '依嚴重程度',
  'workQueue.toolbar.sortBugs': '缺陷優先',
  'workQueue.toolbar.sortFeatures': '功能優先',
  'workQueue.toolbar.toast.bulkAnalyzeDone': '已分析 {done} 個任務',
  'workQueue.toolbar.toast.bulkAnalyzePartial': '已分析 {done} 個，{failed} 個失敗',
  'workQueue.toolbar.toast.bulkAnalyzeFailed': '批次分析失敗',
  'workQueue.board.toast.linearCreateFailed': '已儲存於本機 — 無法建立 Linear 議題',
  'workQueue.detail.analysis.alreadySolvedTitle': '可能已解決',
  'workQueue.detail.analysis.alreadySolvedEvidence': '在提交 {hash} 中發現 — 「{message}」',
  'workQueue.detail.analysis.duplicateTitle': '可能重複',
  'workQueue.detail.analysis.duplicateOf': '可能與「{title}」是同一問題',
  'workQueue.detail.actions.viewDuplicate': '查看原始議題',
  'workQueue.detail.finishDialog.title': '完成任務',
  'workQueue.detail.finishDialog.description': '選擇此任務的關閉方式。',
  'workQueue.detail.finishDialog.reason.completed': '標記為已完成',
  'workQueue.detail.finishDialog.reason.duplicate': '標記為重複並關閉',
  'workQueue.detail.finishDialog.reason.notPlanned': '標記為不再規劃並關閉',
  'workQueue.detail.finishDialog.duplicateOfLabel': '重複自 (URL)',
  'workQueue.detail.finishDialog.duplicateOfPlaceholder': 'https://github.com/... 或 Linear 議題連結',
  'workQueue.detail.finishDialog.cancel': '取消',
  'workQueue.detail.finishDialog.confirm': '關閉任務',
  'workQueue.detail.toast.closedDuplicate': '已標記為重複並關閉',
  'workQueue.detail.toast.closedNotPlanned': '已標記為不再規劃並關閉',
  'workQueue.detail.field.manualEvidence': '手動證據',
  'workQueue.detail.actions.checkStaleness': '檢查提交歷史',
  'workQueue.detail.staleness.match': '在提交 {hash} 中發現 — 「{message}」',
  'workQueue.detail.staleness.noMatches': '未找到相符的提交',
  'workQueue.detail.field.attachedPr': '已關聯的 PR',
  'workQueue.detail.toast.stalenessCheckFailed': '檢查提交歷史失敗',
  'workQueue.detail.toast.prAttached': '已關聯 PR',
  'workQueue.detail.toast.prAttachFailed': '關聯 PR 失敗',
  'workQueue.detail.field.analysisModel': '分析模型',
  'workQueue.detail.analysis.modelAuto': '自動（任一已連接的供應商）',
  'workQueue.detail.analysis.setDefaultModel': '設為預設模型',
  'workQueue.detail.analysis.isDefaultModel': '分析用的預設模型',
  'workQueue.detail.toast.defaultModelSet': '預設分析模型已更新',
  'workQueue.detail.toast.defaultModelSetFailed': '更新預設分析模型失敗',
  'workQueue.cloudAgent.dialog.title': '傳送至雲端代理',
  'workQueue.cloudAgent.dialog.description': '在啟動 Cursor 背景代理前，請檢查提示詞與模型。',
  'workQueue.cloudAgent.dialog.notConnected': 'Cursor 未連線 — 請先在設定中新增 API 金鑰。',
  'workQueue.cloudAgent.dialog.repository': '儲存庫',
  'workQueue.cloudAgent.dialog.model': '模型',
  'workQueue.cloudAgent.dialog.prompt': '提示詞',
  'workQueue.cloudAgent.dialog.send': '傳送',

  'workQueue.cloudAgent.popup.title': '代理已啟動',
  'workQueue.cloudAgent.popup.description': '代理正在背景處理此任務。開啟執行以查看進度。',
  'workQueue.cloudAgent.popup.openRun': '開啟執行',
  'workQueue.cloudAgent.popup.close': '稍後',
