...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.revert.toast.unsupportedHarness': 'Claude Code 会话不支持还原',
  ...
  'sessions.sidebar.footer.actions.workQueue': 'AI 工作队列',
  'workQueue.unavailable': '此运行环境不支持 AI 工作队列',
  'workQueue.window.description': 'AI 工作队列：由 AI 生成的 GitHub 和 Linear 问题分析',
  'workQueue.view.board': '看板',
  'workQueue.view.matrix': '矩阵',
  'workQueue.view.list': '列表',
  'workQueue.view.calendar': '日历',
  'workQueue.view.comingSoon': '即将推出',
  'workQueue.nav.queue': '队列',
  'workQueue.nav.recommended': '推荐',
  'workQueue.nav.critical': '严重',
  'workQueue.nav.in_progress': '进行中',
  'workQueue.nav.cloud_agents': '云代理',
  'workQueue.nav.done': '已完成',
  'workQueue.nav.repositories': '仓库',
  'workQueue.toolbar.searchPlaceholder': '搜索任务、仓库、作者...',

  'workQueue.toolbar.filters': '筛选',
  'workQueue.toolbar.sync': '同步',
  'workQueue.toolbar.filterAll': '全部',
  'workQueue.toolbar.filterRepo': '仓库',
  'workQueue.toolbar.filterAssignee': '负责人',
  'workQueue.toolbar.filterType': '类型',
  'workQueue.toolbar.filterPriority': '优先级',
  'workQueue.toolbar.filterComplexity': '难度',
  'workQueue.toolbar.resetFilters': '重置筛选',
  'workQueue.type.issue': '问题',
  'workQueue.type.pr': '拉取请求',
  'workQueue.issueType.bug': '缺陷',
  'workQueue.issueType.feature': '功能',
  'workQueue.issueType.enhancement': '增强',
  'workQueue.issueType.question': '问题咨询',
  'workQueue.issueType.documentation': '文档',
  'workQueue.priority.critical': '严重',
  'workQueue.priority.high': '高',
  'workQueue.priority.medium': '中',
  'workQueue.priority.low': '低',
  'workQueue.complexity.easy': '简单',
  'workQueue.complexity.medium': '中等',
  'workQueue.complexity.hard': '困难',
  'workQueue.complexity.huge': '非常困难',
  'workQueue.env.headless': '需要无头环境',
  'workQueue.env.browser': '需要浏览器',
  'workQueue.env.docker': '需要 Docker',
  'workQueue.status.todo': '待办',
  'workQueue.status.in_progress': '进行中',
  'workQueue.status.backlog': '需求池',
  'workQueue.status.done': '已完成',
  'workQueue.board.toast.linearSyncFailed': '已在本地保存 — Linear 同步失败',
  'workQueue.board.toast.assigneeSyncFailed': '已在本地保存 — 未能将该事项分配给你',
  'workQueue.board.emptyColumn': '将任务拖放到此处',
  'workQueue.list.empty': '没有任务符合当前筛选条件',
  'workQueue.card.estimateMinutes': '{minutes} 分钟',
  'workQueue.card.confidence': '置信度 {confidence}%',
  'workQueue.card.notAnalyzed': '尚未分析',
  'workQueue.card.analysisError': '分析失败',
  'workQueue.card.analyze': '使用 AI 分析',
  'workQueue.card.reanalyze': '重新分析',
  'workQueue.card.analyzing': '分析中…',
  'workQueue.detail.close': '关闭',
  'workQueue.detail.tab.overview': '概览',
  'workQueue.detail.tab.analysis': 'AI 分析',
  'workQueue.detail.field.priority': '优先级',
  'workQueue.detail.field.complexity': '复杂度',
  'workQueue.detail.field.confidence': 'AI 置信度',
  'workQueue.detail.field.estimate': '预计耗时',
  'workQueue.detail.field.environment': '环境',
  'workQueue.detail.field.author': '作者',
  'workQueue.detail.field.labels': '标签',
  'workQueue.detail.field.generatedPrompt': '生成的提示词',
  'workQueue.detail.cloudAgentStatus': '云代理：{status}',
  'workQueue.detail.actions.take': '认领任务',
  'workQueue.detail.actions.openInOpenChamber': '在 OpenChamber 中打开',
  'workQueue.detail.actions.cloudAgent': '发送给云代理',
  'workQueue.detail.actions.openCloudAgent': '查看代理运行情况',
  'workQueue.detail.actions.copyPrompt': '复制提示词',
  'workQueue.detail.actions.openGitHub': '在 GitHub 中打开',
  'workQueue.detail.actions.openLinear': '在 Linear 中打开',
  'workQueue.detail.actions.finish': '完成',
  'workQueue.detail.actions.analyze': '分析',
  'workQueue.detail.actions.reanalyze': '重新分析',
  'workQueue.detail.error.noActiveProject': '未选择活动项目',
  'workQueue.detail.toast.analyzeFailed': '分析失败',
  'workQueue.detail.toast.promptCopied': '提示词已复制到剪贴板',
  'workQueue.detail.toast.copyFailed': '复制提示词失败',
  'workQueue.detail.toast.cloudAgentFailed': '启动云代理失败',
  'workQueue.detail.toast.finished': '任务已完成并归档',
  'workQueue.detail.toast.finishIncomplete': '未能完成 — 请检查 GitHub/Linear 状态',
  'workQueue.detail.tab.review': 'AI 审查',
  'workQueue.detail.field.description': '描述',

  'workQueue.detail.field.created': '创建时间',
  'workQueue.detail.noDescription': '未提供描述',
  'workQueue.detail.review.empty': '暂无自动审查评论',
  'workQueue.detail.toast.cloudAgentLaunched': '云端代理已启动',
  'workQueue.toolbar.analyzeAll': '全部分析',
  'workQueue.toolbar.analyzeAllWithCount': '全部分析（{count}）',
  'workQueue.toolbar.sortLabel': '排序',
  'workQueue.toolbar.sortDefault': '默认',
  'workQueue.toolbar.sortNewest': '最新优先',
  'workQueue.toolbar.sortOldest': '最旧优先',
  'workQueue.toolbar.sortCriticality': '按严重程度',
  'workQueue.toolbar.sortBugs': '缺陷优先',
  'workQueue.toolbar.sortFeatures': '功能优先',
  'workQueue.toolbar.toast.bulkAnalyzeDone': '已分析 {done} 个任务',
  'workQueue.toolbar.toast.bulkAnalyzePartial': '已分析 {done} 个，{failed} 个失败',
  'workQueue.toolbar.toast.bulkAnalyzeFailed': '批量分析失败',
  'workQueue.board.toast.linearCreateFailed': '已保存到本地 — 无法创建 Linear 问题',
  'workQueue.detail.analysis.alreadySolvedTitle': '可能已解决',
  'workQueue.detail.analysis.alreadySolvedEvidence': '在提交 {hash} 中发现 — "{message}"',
  'workQueue.detail.analysis.duplicateTitle': '可能重复',
  'workQueue.detail.analysis.duplicateOf': '可能与"{title}"是同一问题',
  'workQueue.detail.actions.viewDuplicate': '查看原始问题',
  'workQueue.detail.finishDialog.title': '完成任务',
  'workQueue.detail.finishDialog.description': '选择此任务的关闭方式。',
  'workQueue.detail.finishDialog.reason.completed': '标记为已完成',
  'workQueue.detail.finishDialog.reason.duplicate': '标记为重复并关闭',
  'workQueue.detail.finishDialog.reason.notPlanned': '标记为不再计划并关闭',
  'workQueue.detail.finishDialog.duplicateOfLabel': '重复自 (URL)',
  'workQueue.detail.finishDialog.duplicateOfPlaceholder': 'https://github.com/... 或 Linear 问题链接',
  'workQueue.detail.finishDialog.cancel': '取消',
  'workQueue.detail.finishDialog.confirm': '关闭任务',
  'workQueue.detail.toast.closedDuplicate': '已标记为重复并关闭',
  'workQueue.detail.toast.closedNotPlanned': '已标记为不再计划并关闭',
  'workQueue.detail.field.manualEvidence': '手动证据',
  'workQueue.detail.actions.checkStaleness': '检查提交历史',
  'workQueue.detail.staleness.match': '在提交 {hash} 中发现 — "{message}"',
  'workQueue.detail.staleness.noMatches': '未找到匹配的提交',
  'workQueue.detail.field.attachedPr': '已关联的 PR',
  'workQueue.detail.toast.stalenessCheckFailed': '检查提交历史失败',
  'workQueue.detail.toast.prAttached': '已关联 PR',
  'workQueue.detail.toast.prAttachFailed': '关联 PR 失败',
  'workQueue.detail.field.analysisModel': '分析模型',
  'workQueue.detail.analysis.modelAuto': '自动（任意已连接的提供方）',
  'workQueue.detail.analysis.setDefaultModel': '设为默认模型',
  'workQueue.detail.analysis.isDefaultModel': '分析使用的默认模型',
  'workQueue.detail.toast.defaultModelSet': '默认分析模型已更新',
  'workQueue.detail.toast.defaultModelSetFailed': '更新默认分析模型失败',
  'workQueue.cloudAgent.dialog.title': '发送到云端代理',
  'workQueue.cloudAgent.dialog.description': '在启动 Cursor 后台代理前，请检查提示词和模型。',
  'workQueue.cloudAgent.dialog.notConnected': 'Cursor 未连接 — 请先在设置中添加 API 密钥。',
  'workQueue.cloudAgent.dialog.repository': '仓库',
  'workQueue.cloudAgent.dialog.model': '模型',
  'workQueue.cloudAgent.dialog.prompt': '提示词',
  'workQueue.cloudAgent.dialog.send': '发送',

  'workQueue.cloudAgent.popup.title': '代理已启动',
  'workQueue.cloudAgent.popup.description': '代理正在后台处理此任务。打开运行以查看进度。',
  'workQueue.cloudAgent.popup.openRun': '打开运行',
  'workQueue.cloudAgent.popup.close': '稍后',
  'workQueue.cloudAgent.dialog.cancel': '取消',
};
