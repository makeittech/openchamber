...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.engine.cursorTooltip': '正在 Cursor 上运行',
  ...
  'chat.engines.cursor.notReady': 'Cursor 尚未就绪。请打开设置 → 引擎以登录或重新检测。',
  'chat.engines.cursor.shellUnsupported': 'Cursor 不支持 Shell 模式。请切换到 OpenCode，或发送普通消息。',
  'chat.engines.cursor.slashUnsupported': 'Cursor 不支持斜杠命令。请切换到 OpenCode，或发送普通消息。',
  ...
  'chat.handoff.cursorBillingDialog.title': '在 Cursor 上继续？',
  'chat.handoff.cursorBillingDialog.body': '这将使用你的 Cursor 订阅开始新会话。OpenCode API 提供商保持不变。对话文本会复制为上下文；原始会话保持不变。',
