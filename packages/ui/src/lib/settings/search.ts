...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  {
    id: 'ai-workflow.linear-workspace',
    page: 'ai-workflow',
    titleKey: 'settings.linear.page.title',
    keywords: ['linear', 'issues', 'oauth', 'automation'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'ai-workflow.cursor-workspace',
    page: 'ai-workflow',
    titleKey: 'settings.cursor.page.title',
    keywords: ['cursor', 'cloud agent', 'api key', 'repos'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'ai-workflow.analysis-model',
    page: 'ai-workflow',
    titleKey: 'settings.aiWorkflow.page.section.analysisModel',
    descriptionKey: 'settings.aiWorkflow.page.info.analysisModel',
    keywords: ['model', 'provider', 'default', 'analysis', 'workqueue'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'ai-workflow.analysis-prompt',
    page: 'ai-workflow',
    titleKey: 'settings.aiWorkflow.page.section.analysisPrompt',
    descriptionKey: 'settings.aiWorkflow.page.info.analysisPrompt',
    keywords: ['analysis', 'prompt', 'instructions', 'workqueue'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'ai-workflow.already-solved-prompt',
    page: 'ai-workflow',
    titleKey: 'settings.aiWorkflow.page.section.alreadySolvedPrompt',
    descriptionKey: 'settings.aiWorkflow.page.info.alreadySolvedPrompt',
    keywords: ['already solved', 'duplicate', 'prompt', 'instructions'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'ai-workflow.remote-agent-prompt',
    page: 'ai-workflow',
    titleKey: 'settings.aiWorkflow.page.section.remoteAgentPrompt',
    descriptionKey: 'settings.aiWorkflow.page.info.remoteAgentPrompt',
    keywords: ['remote agent', 'cursor', 'cloud agent', 'prompt', 'dispatch'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
